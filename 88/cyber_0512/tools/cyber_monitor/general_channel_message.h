 ...
 private:
  explicit GeneralChannelMessage(const std::string& node_name,
      ...
      : GeneralMessageBase(parent),
        ...
        message_type_(),
        frame_counter_(0),
        last_time_(century::cyber::Time::MonoTime()),
  ...
  void UpdateRawMessage(
      const std::shared_ptr<century::cyber::message::RawMessage>& raw_msg) {
    set_has_message_come(true);
    msg_time_ = century::cyber::Time::MonoTime();
    ++frame_counter_;
  ...
  std::shared_ptr<century::cyber::message::RawMessage> CopyMsgPtr(void) const {
  ...
  century::cyber::Time last_time_;
  century::cyber::Time msg_time_;
  century::cyber::Time time_last_calc_ = century::cyber::Time::MonoTime();

  std::unique_ptr<century::cyber::Node> channel_node_;
  ...
  std::shared_ptr<century::cyber::message::RawMessage> channel_message_;
  std::shared_ptr<century::cyber::Reader<century::cyber::message::RawMessage>>
      channel_reader_;
