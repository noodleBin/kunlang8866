...
const std::string& MessageDetail() {
  static const std::string detail =
      std::string("received_msg=") +
      common::DemangleTypeName(message::MessageType<M0>().c_str());
  return detail;
}
...
bool Component<M0, NullType, NullType, NullType>::Process(
  ...
  const std::string trace_name =
      node_ == nullptr ? "standalone_component" : node_->Name();
  if (!common::CallbackTraceShouldTrace("component", trace_name)) {
    return Proc(msg);
  }
  common::CallbackTrace trace(
      "component", trace_name.c_str(),
      callback_trace_detail::MessageDetail<M0>().c_str());
  return Proc(msg);
}
...
bool Component<M0, M1, NullType, NullType>::Process(
  ...
  common::CallbackTrace trace(
      "component", trace_name.c_str(),
      callback_trace_detail::MessageDetail<M0, M1>().c_str());
  return Proc(msg0, msg1);
}
...
bool Component<M0, M1, M2, NullType>::Process(const std::shared_ptr<M0>& msg0,
  ...
  common::CallbackTrace trace(
      "component", trace_name.c_str(),
      callback_trace_detail::MessageDetail<M0, M1, M2>().c_str());
  return Proc(msg0, msg1, msg2);
}
...
bool Component<M0, M1, M2, M3>::Process(const std::shared_ptr<M0>& msg0,
  ...
  common::CallbackTrace trace(
      "component", trace_name.c_str(),
      callback_trace_detail::MessageDetail<M0, M1, M2, M3>().c_str());
  return Proc(msg0, msg1, msg2, msg3);
}
