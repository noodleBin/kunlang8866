...
using century::cyber::proto::Param;
using century::cyber::proto::ParamType;
...
TEST_F(ParameterTest, type_name) {
  ...
  EXPECT_EQ("century.cyber.proto.Param", protobuf_param_->TypeName());
}
...
TEST_F(ParameterTest, debug_string) {
  ...
  EXPECT_EQ(
      "{name: \"protobuf\", type: \"century.cyber.proto.Param\", value: "
      "\"name: \"param\"\"}",
