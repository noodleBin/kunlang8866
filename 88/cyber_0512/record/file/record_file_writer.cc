...
using century::cyber::proto::Channel;
using century::cyber::proto::ChannelCache;
using century::cyber::proto::ChunkBody;
using century::cyber::proto::ChunkBodyCache;
using century::cyber::proto::ChunkHeader;
using century::cyber::proto::ChunkHeaderCache;
using century::cyber::proto::Header;
using century::cyber::proto::SectionType;
using century::cyber::proto::SingleIndex;
...
bool RecordFileWriter::Open(const std::string& path) {
  ...
  path_ = path;
  if (::century::cyber::common::PathExists(path_)) {
