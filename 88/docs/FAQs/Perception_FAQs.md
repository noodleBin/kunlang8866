...
[calibration guide](../quickstart/century_2_0_sensor_calibration_guide.md)

For additional information on LiDAR - GNSS calibration please refer to our
[LiDAR - GNSS calibration guide](https://github.com/CenturyAuto/century/blob/r1.5.0/docs/quickstart/century_1_5_lidar_calibration_guide.md)
...
## I am trying to run the extrinsic sensor calibration tools and they seem to complain about the INS_STAT not being 56. But when I echo the /century/sensor/gnss/ins_stat topic I can see that the position type is 56. What could be the problem?
