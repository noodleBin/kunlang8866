# Century 1.5 Quick Start Guide

This quick start focuses on Century 1.5 new features. For general Century concepts, please refer to [Century 1.0 Quick Start](https://github.com/CenturyAuto/century/blob/master/docs/quickstart/century_1_0_quick_start.md) and [Century Software Installation Guide](https://github.com/CenturyAuto/century/blob/master/docs/quickstart/century_software_installation_guide.md).

# Onboard Test

1. For vehicle onboard test, make sure you have calibrated the extrinsic parameters between the LiDAR and the GNSS/INS. For sensor calibration, please refer to [Century 1.5 LiDAR calibration guide](https://github.com/CenturyAuto/century/blob/master/docs/specs/century_lidar_imu_calibration_guide.md) before you proceed.
...
4. Select Vehicle and Map
    ...
    You'll be required to setup profile before doing anything else. Click the dropdown menu to select your HDMap and vehicle in use. The list are defined in [HMI config file](https://raw.githubusercontent.com/CenturyAuto/century/master/modules/hmi/conf/config.pb.txt).
