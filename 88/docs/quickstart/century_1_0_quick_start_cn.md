# Century 快速入门指南  1.0
## 目录
- [Century 快速入门指南  1.0](#century-快速入门指南-10)
  - [目录](#目录)
- [关于这个文档](#关于这个文档)
  - [文档规约](#文档规约)
- [概览](#概览)
...
_Century 快速入门指南 1.0_ 提供了所有关于了解、安装以及构建Century的基本说明
...
Century 1.0, 也被称为 _Automatic GPS Waypoint Following(自动GPS跟随)_, 使用在封闭的区域内，如测试轨道或停车场。它可以准确地以人类驾驶员在封闭的平坦区域的速度复现一个驾驶轨迹。

在这个开发阶段, Century 1.0 **无法** 察觉到邻近的障碍物, **不要**在公共道路或没有GPS信号的区域行驶。
...
请参考 [Century 1.0 Hardware and System Installation Guide](https://github.com/CenturyAuto/century/blob/r1.0.0/docs/quickstart/century_1_0_hardware_system_installation_guide.md)
中的步骤来安装硬件组件以及系统软件

# 软件安装

请参考[Century软件安装指南](https://github.com/CenturyAuto/century/blob/r3.0.0/docs/quickstart/century_software_installation_guide_cn.md)

# 在车辆上运行示例

本节提供运行Century 1.0 Demo on Vehicle的说明。
1. 设置硬件：
...
1. 在Century HMI中，在**Quick Record**下，单击**Setup**以启动所有模块并执行硬件运行状况检查。
...
1. 在Century HMI中，在Quick Play下，单击 **Setup** 启动所有模块并执行硬件运行状况检查。
...
# 运行离线演示
参考 [Offline Demo Guide](https://github.com/CenturyAuto/century/blob/r1.0.0/docs/demo_guide/README.md)
