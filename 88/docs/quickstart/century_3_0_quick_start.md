# Century 3.0 Quick Start Guide

The following guide serves as a user manual for launching the Century 3.0
software and hardware stack on vehicle.

The Century 3.0 Quick Start Guide focuses on Century 3.0's new features. For general
...
Please refer to
[Century 3.0 Hardware and System Installation Guide](https://github.com/CenturyAuto/century/blob/master/docs/quickstart/century_3_0_hardware_system_installation_guide.md)
