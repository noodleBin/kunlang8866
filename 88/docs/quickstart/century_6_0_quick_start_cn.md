...
以下指南是用于在车辆上启动Century软硬件套件的用户手册， 整体内容与Century 5.5类似。本快速入门指南重点介绍新功能，对于 Century 的一般概念，请参阅[Century 5.5 快速入门指南](century_5_5_quick_start.md)

## 内容

- [Century 6.0 快速入门指南](#century-60-快速入门指南)
  - [内容](#内容)
  - [紧急车辆音频检测](#紧急车辆音频检测)
  - [硬件和软件安装](#硬件和软件安装)
...
Century目前通过音频设备集成了紧急车辆检测功能。在自动驾驶车辆上安装麦克风采集周围的音频信号，并对记录的音频进行分析和处理，以检测周围的紧急车辆。模块详细信息在[这里](../../modules/audio)。

Century集成了新的深度学习模型，包括使用PointPillars进行障碍物检测、使用语义地图进行行人预测以及基于学习的轨迹规划。请在对应的模块中寻找详细的信息。

## 硬件和软件安装

Century 6.0的硬件设置与Century 3.5相同，请参阅[Century 3.5 硬件与系统安装指南](century_3_5_hardware_system_installation_guide.md)获取安装硬件组件的步骤，参阅[Century软件安装指南](century_software_installation_guide_cn.md)获取软件安装步骤。
