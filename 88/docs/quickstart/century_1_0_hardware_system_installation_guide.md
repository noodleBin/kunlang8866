# Century 1.0 Hardware and System Installation Guide
...
The *Century 1.0 Hardware and System Installation Guide* provides the instructions to install all of the hardware components and system software for the **Century Project **. The system installation information included pertains to the procedures to download and install the Century Linux Kernel.
...
The following set of documentation describes Century 1.0:
...
For example, Century 1.0 uses 4x4 self-tapping screws to bolt the 5059GC to the carpeted floor of the trunk. ![IPC-bolt_down-936x720](images/IPC-bolt_down-936x720.jpg)
...
After you complete the hardware installation in the vehicle, see the [Century Quick Start](https://github.com/CenturyAuto/century/blob/master/docs/quickstart/century_1_0_quick_start.md) for the steps to complete the software installation.
