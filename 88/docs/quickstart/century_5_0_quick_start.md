# Century 5.0 Quick Start Guide

The following guide serves as a user manual for launching the Century upgraded software and hardware stack on vehicle.

This Quick Start Guide focuses on the new features. For general Century concepts, please refer to
...
Century currently offers a robust calibration service to support your calibration requirements from LiDARs to IMU to Cameras. This service is being offered to selected partners only. If you would like to learn more about the calibration service, please reach out to us via email: **centurypartner@baidu.com**

## Hardware and Software Installation

The Hardware setup for Century 5.0 remains the same as Century 3.5, please refer to
