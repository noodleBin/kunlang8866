# Century 2.0 Hardware and System Installation Guide
...
The *Century 2.0 Hardware and System Installation Guide* provides the instructions to install all of the hardware components and system software for the **Century Project**. The system installation information included pertains to the procedures to download and install the Century Linux Kernel.
...
The following set of documentation describes Century 2.0:
...
- ***<u>[Century Quick Start Guide]</u>*** ─ A combination tutorial and roadmap that provide the complete set of end-to-end instructions. The Quick Start Guide also provides links to additional documents that describe the conversion of a regular car to an autonomous-driving vehicle.
...
The Century reference design recommends using two cameras with different focal lengths, 6 mm and 25 mm. The mounting of the cameras can be tailored to the actual design of the system. 
...
2.   Place the onboard computer system, the 6108GC, inside the trunk (recommended).
     ...
     For example, Century 2.0 uses 4x4 self-tapping screws to bolt the 6108GC to the carpeted floor of the trunk. ![IPC-bolt_down-936x720](images/Mount_ipc_on_carpet.jpg)
...
After you complete the hardware installation in the vehicle, see the [Century Quick Start](https://github.com/CenturyAuto/century/blob/master/docs/quickstart/century_1_5_quick_start.md) for the steps to complete the software installation.
