# Century 2.5 地图采集功能使用指南

本文档主要用来说明如何在 Century2.5 中使用地图数据采集的功能.重点介绍了数据采集所
需的软硬件环境,数据采集的流程和注意事项.

## 软硬件环境准备

1、硬件安装方法参
见[Century 2.5 硬件安装指南](../quickstart/century_2_5_hardware_system_installation_guide_v1.md)

2、软件安装方法参
见[Century 软件安装指南](../quickstart/century_software_installation_guide.md)

3、传感器标定方法参
见[Century 传感器标定方法使用指南](../quickstart/multiple_lidar_gnss_calibration_guide.md)
...
1、启动地图采集模式 Century 环境启动参
见[Century 2.5 快速上手指南](../quickstart/century_2_5_quick_start_cn.md)
...
采集的数据放置在/century/data/bag/(采集开始时间,例如 2018-04-14-21-20-24)目录，把
该目录下的数据打包为 tar.gz 压缩文件，
到[Century 数据官网](http://data.century.auto/hd_map_intro/?locale=zh-cn)进行数据
上传。
