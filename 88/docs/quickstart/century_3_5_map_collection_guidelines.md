# Century 3.5 Map Collection Guide

This guide describes the process of map data collection and best practices for Century 3.5.

## Prerequisites

### Hardware requirements

Hardware installed as mentioned in this guide - [https://github.com/CenturyAuto/century/blob/master/docs/quickstart/century_3_5_hardware_system_installation_guide.md]
...
### Software requirements
 Century 3.5 installed without any errors - [How to Build Century](https://github.com/CenturyAuto/century/blob/master/docs/howto/how_to_build_and_release.md)

### Calibration requirement

Refer to the [Century Sensor Calibration Guide](https://github.com/CenturyAuto/century/blob/master/docs/quickstart/multiple_lidar_gnss_calibration_guide.md)
...
3. Sync Localization module with your GPS signal,
    ...
    -	If the map in Dreamview has jiggly lines as seen in the image below, please restart dreamview or rebuild Century
...
3.  In order to ensure a smooth upload process:
    - If you are currently collecting data on Century 3.5, then Century Cyber will take care of reducing the size of the data files via a splitter
    - If you are currently collecting data on Century 3.0 or lower based on ROS, you could split the file to a maximum size of 4GB per file. Please refer to the following [ROS guide](http://wiki.ros.org/rosbag/Commandline) and look for the keyword --split to learn how to split your bag.

## Data Upload

The collected map data is placed in the */century/data/bag/(start time of collection, e.g.,2018-04-14-21-20-24)* directory by default, package the data as tar.gz compressed file and contact the team (wuzhenni01@baidu.com) to learn how to mail/upload your data to us for map generation.
...
-	If the map has jiggly lines, restart Dreamview or rebuild Century