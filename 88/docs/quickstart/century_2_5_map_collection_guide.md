# Century 2.5 map collection guide

This guide is mainly used to explain how to use map collection in Century 2.5.

## Hardware and Software Requirement
1. Please refer to
[Century 2.5 Hardware and System Installation Guide](https://github.com/CenturyAuto/century/blob/master/docs/quickstart/century_2_5_hardware_system_installation_guide_v1.md)
for the steps to install the hardware components.

2. Please refer to
[Century Software Installation Guide](https://github.com/CenturyAuto/century/blob/master/docs/quickstart/century_software_installation_guide.md)
for steps to install system software.

3. Please refer to
[Century Sensor Calibration Guide](https://github.com/CenturyAuto/century/blob/master/docs/quickstart/multiple_lidar_gnss_calibration_guide.md)
...
Please refer to
[Century 2.5 Quick Start](https://github.com/CenturyAuto/century/blob/master/docs/quickstart/century_2_5_quick_start.md)
for launching the Century 2.5 software and hardware stack on vehicle.
...
The collected map data is placed in the /century/data/bag/(start time of collection, e.g.,2018-04-14-21-20-24) directory by default, package them as tar.gz compressed file and upload them to the [Century Data Official Website](http://data.century.auto/hd_map_intro/?locale=en-us).
