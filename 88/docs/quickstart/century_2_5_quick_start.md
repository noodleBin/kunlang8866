# Century 2.5 Quick Start Guide

The following guide serves as a user manual for launching the Century 2.5
software and hardware stack on vehicle.

The Century 2.5 Quick Start Guide focuses on Century 2.5 new features. For general
Century concepts, please refer to
...
[Century 2.0 Sensor Calibration Guide](https://github.com/CenturyAuto/century/blob/master/docs/quickstart/century_2_0_sensor_calibration_guide.md)
before you proceed.
