# Century 1.0 Quick Start Guide
## Contents
* [About This Guide](#about-this-guide)
    * [Document Conventions](#document-conventions)
* [Overview of Century](#overview-of-century)
* [Description of the Vehicle Environment](#description-of-the-vehicle-environment)
* [Hardware Installation](#hardware-installation)
* [Century Software Installation](#century-software-installation)
...
The _Century 1.0 Quick Start Guide_ provides all of the basic instructions to understand, install, and build Century.
...
Century 1.0, also referred to as the _Automatic GPS Waypoint Following_, works in an enclosed venue such as a test track or parking lot. It accurately replays a trajectory and the speed of that trajectory that a human driver has traveled in an enclosed, flat area on solid ground.

At this stage of development, Century 1.0 **cannot** perceive obstacles in close proximity, drive on public roads, or drive in areas without GPS signals.
...
Please refer to [Century 1.0 Hardware and System Installation Guide](https://github.com/CenturyAuto/century/blob/master/docs/quickstart/century_1_0_hardware_system_installation_guide.md)
for the steps to install the hardware components and the system software.

# Century Software Installation

Please refer to [Century Software Installation Guide](https://github.com/CenturyAuto/century/blob/master/docs/quickstart/century_software_installation_guide.md).

# Run Demo on Vehicle

This section provides the instructions to run the Century 1.0 Demo on Vehicle.
...
Open the Chrome browser and start the Century HMI by going to **192.168.10.6:8887**.
...
1. In the Century HMI, under Quick Record, click **Setup** to start all modules and perform the hardware health check.
...
1. In the Century HMI, under Quick Play, click **Setup** to start all modules and perform a hardware health check.
...
# Run Offline Demo
See [Offline Demo Guide](https://github.com/CenturyAuto/century/blob/master/docs/demo_guide/README.md)
