# Century 1.5 Hardware and System Installation Guide
...
The *Century 1.5 Hardware and System Installation Guide* provides the instructions to install all of the hardware components and system software for the **Century Project **. The system installation information included pertains to the procedures to download and install the Century Linux Kernel.
...
The following set of documentation describes Century 1.5:
...
The Century runtime in the vehicle requires the [Century Kernel](https://github.com/CenturyAuto/century-kernel). You are strongly recommended to install the pre-built kernel.

##### Use pre-built Century Kernel.
...
4. Build the ESD CAN driver source code
  Now you need to build the ESD CAN driver source code according to [ESDCAN-README.md](https://github.com/CenturyAuto/century-kernel/blob/master/linux/ESDCAN-README.md)
...
bash build.sh
```
4. Install the kernel the same way as using a pre-built Century Kernel.

#### Installing Nvidia GPU Driver

The Century runtime in the vehicle requires the [Nvidia GPU Driver](http://www.nvidia.com/download/driverResults.aspx/114708/en-us). You are required to install the Nvidia GPU driver with specific options.
...
2.   Place the onboard computer system, the 6108GC, inside the trunk (recommended).
     ...
     For example, Century 1.5 uses 4x4 self-tapping screws to bolt the 6108GC to the carpeted floor of the trunk. ![IPC-bolt_down-936x720](images/Mount_ipc_on_carpet.jpg)
