# Century 3.5 Hardware and System Installation Guide

- [Century 3.5 Hardware and System Installation Guide](#century-35-hardware-and-system-installation-guide)
...
The _Century master Hardware and System Installation Guide_ provides the
instructions to install all of the hardware components and system software for
the **Century Project**. The system installation information included pertains to
the procedures to download and install the Century Linux Kernel.
...
The **Century Project** is an initiative that provides an open, complete, and
reliable software platform for Century partners in the automotive and autonomous
driving industries. The aim of this project is to enable these entities to
develop their own self-driving systems based on the Century software stack.

### Documentation

The following set of documentation describes Century 3.0:

- **_</u>[Century Hardware and System Installation Guide]</u>_** ─ Links to the
  Hardware Development Platform Documentation in Specs

  - **Vehicle**:

    - [Industrial PC (IPC)](https://github.com/CenturyAuto/century/blob/master/docs/specs/IPC/Nuvo-6108GC_Installation_Guide.md)
    - [Global Positioning System (GPS)](https://github.com/CenturyAuto/century/blob/master/docs/specs/Navigation/README.md)
    - [Inertial Measurement Unit (IMU)](https://github.com/CenturyAuto/century/blob/master/docs/specs/Navigation/README.md)
    - Controller Area Network (CAN) card
    - GPS Antenna
    - GPS Receiver
    - [Light Detection and Ranging System (LiDAR)](https://github.com/CenturyAuto/century/blob/master/docs/specs/Lidar/README.md)
    - [Camera](https://github.com/CenturyAuto/century/blob/master/docs/specs/Camera/README.md)
    - [Radar](https://github.com/CenturyAuto/century/blob/master/docs/specs/Radar/README.md)
    - [Century Sensor Unit (ASU)](https://github.com/CenturyAuto/century/blob/master/docs/specs/Century_Sensor_Unit/Century_Sensor_Unit_Installation_Guide.md)
    - Century Extension Unit (AXU)

  - **Software**: Refer to the
    [Software Installation Guide](https://github.com/CenturyAuto/century/blob/master/docs/quickstart/century_software_installation_guide.md)
    for information on the following:
    - Ubuntu Linux
    - Century Linux Kernel
    - NVIDIA GPU Driver

- **_</u>[Century Quick Start Guide]</u>_** ─ The combination of a tutorial and a
...
- Light Detection and Ranging System (LiDAR) ─ You can select one of the
  following options, please note Century master uses VLS-128 LiDAR:
...
2. Establish a Wi-Fi connection on the Apple iPad Pro to access the HMI and
   control the Century ADS that is running on the IPC.

## Time Sync Script Setup [Optional]

In order to sync the computer time with NTP servers on the internet, you could
use the
[Time Sync script](https://github.com/CenturyAuto/century/blob/master/scripts/time_sync.sh)

## Next Steps

After you complete the hardware installation in the vehicle, see the
[Century Quick Start](century_3_5_quick_start.md) for the steps to complete the
