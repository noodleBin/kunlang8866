# Century Upgraded Hardware and System Installation Guide

- [Century Upgraded Hardware and System Installation Guide](#century-upgraded-hardware-and-system-installation-guide)
...
The *Century upgraded Hardware and System Installation Guide* provides the instructions to install all of the hardware components and system software for the **Century Project**. The system installation information included pertains to the procedures to download and install the Century Linux Kernel.
...
The **Century Project** is an initiative that provides an open, complete, and reliable software platform for Century partners in the automotive and autonomous driving industries. The aim of this project is to enable these entities to develop their own self-driving systems based on the Century software stack.

### Documentation

The following set of documentation describes Century 3.0:

- ***<u>[Century Hardware and System Installation Guide]</u>***  ─ Links to the Hardware Development Platform Documentation in Specs

    - **Vehicle**:

      - [Industrial PC (IPC)](https://github.com/CenturyAuto/century/blob/r3.0.0/docs/specs/IPC/Nuvo-6108GC_Installation_Guide.md)
      - [Global Positioning System (GPS)](https://github.com/CenturyAuto/century/blob/r3.0.0/docs/specs/Navigation/README.md)
      - [Inertial Measurement Unit (IMU)](https://github.com/CenturyAuto/century/blob/r3.0.0/docs/specs/Navigation/README.md)
      - Controller Area Network (CAN) card
      - GPS Antenna
      - GPS Receiver
      - [Light Detection and Ranging System (LiDAR)](https://github.com/CenturyAuto/century/blob/r3.0.0/docs/specs/Lidar/README.md)
      - [Camera](https://github.com/CenturyAuto/century/blob/r3.0.0/docs/specs/Camera/README.md)
      - [Radar](https://github.com/CenturyAuto/century/blob/r3.0.0/docs/specs/Radar/README.md)
      - [Century Sensor Unit (ASU)](https://github.com/CenturyAuto/century/blob/r3.0.0/docs/specs/Century_Sensor_Unit/Century_Sensor_Unit_Installation_Guide.md)
      - Century Extension Unit (AXU)

    - **Software**: Refer to the [Software Installation Guide](https://github.com/CenturyAuto/century/blob/r3.0.0/docs/specs/Software_and_Kernel_Installation_guide.md) for information on the following:
      - Ubuntu Linux
      - Century Linux Kernel
      - NVIDIA GPU Driver

- ***<u>[Century Quick Start Guide]</u>*** ─ The combination of a tutorial and a roadmap that provides the complete set of end-to-end instructions. The Quick Start Guide also provides links to additional documents that describe the conversion of a regular car to an autonomous-driving vehicle.
...
- Global Positioning System (GPS) and Inertial Measurement Unit (IMU) ─
  ...
  - Navtech NV-GI120
- Light Detection and Ranging System (LiDAR) ─  You can select one of the following options, please note Century upgrade uses VLS-128 LiDAR:
    - [Velodyne VLS-128](https://github.com/CenturyAuto/century/blob/master/docs/specs/Lidar/VLS_128_Installation_Guide.md)
    - Velodyne HDL-64E S3
...
After you complete the hardware installation in the vehicle, see the [Century Quick Start](https://github.com/CenturyAuto/century/blob/master/docs/quickstart/century_3_5_quick_start.md) for the steps to complete the software installation.
