# Century 5.5 Quick Start Guide

The following guide serves as a user manual for launching the Century upgraded software and hardware stack on vehicle.

The latest Century upgrade, Quick Start Guide focuses on the new features. For general Century concepts, please refer to
[Century 3.5 Quick Start](https://github.com/CenturyAuto/century/blob/master/docs/quickstart/century_3_5_quick_start.md)
...
Century currently offers a robust calibration service to support your calibration requirements from LiDARs to IMU to Cameras. This service is currently being offered to select partners only as part of our Data Pipeline service offering. If you would like to learn more about the calibration service, please reach out to us via email: **centurypartner@baidu.com**

## Hardware and Software Installation

The Hardware setup for Century 5.5 remains the same as Century 3.5, please refer to
[Century 3.5 Hardware and System Installation Guide](century_3_5_hardware_system_installation_guide.md)
for the steps to install the hardware components and the system software, as well as
[Century Software Installation Guide](century_software_installation_guide.md).

## Dreamview Usage Table

For questions regarding Dreamview icons refer to the
[Dreamview Usage Table](https://github.com/CenturyAuto/century/blob/master/docs/specs/dreamview_usage_table.md).
For questions regarding Dreamland and the scenario editor, please visit our [Dreamland Introduction guide](https://github.com/CenturyAuto/century/blob/master/docs/specs/Dreamland_introduction.md)
...
5. Select Mode, Vehicle and Map
   ...
   [HMI config file](https://raw.githubusercontent.com/CenturyAuto/century/master/modules/dreamview/conf/hmi.conf)
