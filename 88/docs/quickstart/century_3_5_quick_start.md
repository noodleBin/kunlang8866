# Century 3.5 Quick Start Guide

The following guide serves as a user manual for launching the Century 3.5
software and hardware stack on vehicle.

The Century 3.5 Quick Start Guide focuses on new features available in Century
3.5. For general Century concepts, please refer to
[Century 1.0 Quick Start](century_1_0_quick_start.md).
...
[Century 2.0 Sensor Calibration Guide](century_2_0_sensor_calibration_guide.md)
before you proceed.
...
5. Select Mode, Vehicle and Map.
   ...
   [HMI config file](https://raw.githubusercontent.com/CenturyAuto/century/r3.0.0/modules/dreamview/conf/hmi.conf).
