# Century 3.0 Hardware and System Installation Guide

- [Century 3.0 Hardware and System Installation Guide](#century-30-hardware-and-system-installation-guide)
...
The *Century 3.0 Hardware and System Installation Guide* provides the instructions to install all of the hardware components and system software for the **Century Project**. The system installation information included pertains to the procedures to download and install the Century Linux Kernel.
...
![major_component_side_view](https://github.com/CenturyAuto/century/blob/master/docs/demo_guide/images/Hardware_overview.png)
...
After you complete the hardware installation in the vehicle, see the [Century Quick Start](https://github.com/CenturyAuto/century/blob/master/docs/quickstart/century_3_0_quick_start.md) for the steps to complete the software installation.
