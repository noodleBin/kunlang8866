# Century Cyber RT FAQs

## What is Century Cyber RT?

Century's Cyber RT is an open source runtime framework designed specifically for
...
- During years of development of autonomous driving technologies, we have
  learned a lot from our previous experience with Century. In autonomous driving
...
- The industry is evolving, so does Century. Going forward, Century has already
  ...
  That’s why we spent years of building Century Cyber RT, which addresses that
...
- If the data you have collected is compatible with the previous versions of
  Century, you could use our recommended conversion tools to make the data
...
We will continue to support previous Century releases (3.0 and before) based on
ROS. We do appreciate you continue growing with us and highly encourage you to
move to Century 3.5. While we know that some of our developers would prefer to
work on ROS, we do hope you will understand why Century as a team cannot continue
...
worked on Century's module code base, you will not be affected by the
...
- Fork and clone the Century repo with the new framework code which can be found
  at [century/cyber](../../cyber/)
...
- talker:
  https://github.com/gruminions/century/blob/record/cyber/examples/talker.cc
- listener:
  https://github.com/gruminions/century/blob/record/cyber/examples/listener.cc
