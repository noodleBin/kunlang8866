...
```cpp
std::unique_ptr<Node> century::cyber::CreateNode(const std::string& node_name, const std::string& name_space = "");
```
...
using century::cyber::proto::Chatter;
int main(int argc, char *argv[]) {
  // init cyber framework
  century::cyber::Init(argv[0]);
  // create talker node
  std::shared_ptr<century::cyber::Node> talker_node(
      century::cyber::CreateNode("talker"));
  // create talker
  auto talker = talker_node->CreateWriter<Chatter>("channel/chatter");
  Rate rate(1.0);
  while (century::cyber::OK()) {
    static uint64_t seq = 0;
    auto msg = std::make_shared<century::cyber::proto::Chatter>();
...
void MessageCallback(
    const std::shared_ptr<century::cyber::proto::Chatter>& msg) {
...
int main(int argc, char *argv[]) {
  ...
  auto listener_node = century::cyber::CreateNode("listener");
  // create listener
  auto listener =
      listener_node->CreateReader<century::cyber::proto::Chatter>(
...
syntax = "proto2";
package century.cyber.examples.proto;
message Driver {
...
using century::cyber::examples::proto::Driver;

int main(int argc, char* argv[]) {
  century::cyber::Init(argv[0]);
  std::shared_ptr<century::cyber::Node> node(
      century::cyber::CreateNode("start_node"));
...
- Examining result: you should see content below in century/data/log/service.INFO
...
All parameters passed through cyber are `century::cyber::Parameter` objects, the table below lists the 5 supported parameter types.

Parameter type | C++ data type | protobuf data type
:------------- | :------------- | :--------------
century::cyber::proto::ParamType::INT    |   int64_t |   int64
century::cyber::proto::ParamType::DOUBLE | double | double
century::cyber::proto::ParamType::BOOL   | bool |bool
century::cyber::proto::ParamType::STRING  | std::string | string
century::cyber::proto::ParamType::PROTOBUF  | std::string | string
century::cyber::proto::ParamType::NOT_SET | - | -
...
Parameter a("int", 10);
a.Name();  // return int
a.Type();  // return century::cyber::proto::ParamType::INT
...
using century::cyber::Parameter;
using century::cyber::ParameterServer;
using century::cyber::ParameterClient;

int main(int argc, char** argv) {
  century::cyber::Init(*argv);
  std::shared_ptr<century::cyber::Node> node =
      century::cyber::CreateNode("parameter");
...
```
export GLOG_log_dir=/century/data/log
...
```cpp++
century::cyber::cyber::Init(argv[0]) is initialized.
...
using century::cyber::Component;
using century::cyber::ComponentBase;
using century::cyber::TimerComponent;
...
const char MESSAGE_TYPE_1[] = "century.cyber.proto.Test";
const char MESSAGE_TYPE_2[] = "century.cyber.proto.Channel";
