...
The PwrPak7 receiver supports dual antenna, ANT1 is the port on top and considered as primary antenna, which is required by Century system. ANT2 is the port on bottom and considered as secondary antenna, and this is optional.
