...
Century使用来自Velodyne LiDAR, Inc.的64线激光雷达系统 **HDL-64E S3**。
...
默认情况下，HDL-64E S3的网络IP地址为192.168.0.1。 但是，在设置Century时，请将网络IP地址更改为 **192.168.20.13** 。 您可以将终端应用程序与Termite3.2一起使用。可以使用以下步骤配置HDL-64E S3的IP地址：
