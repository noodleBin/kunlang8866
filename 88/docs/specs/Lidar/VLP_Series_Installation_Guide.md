...
#### Configuration
By default, the LiDAR has the network IP address of 192.168.0.201. However, when you setting up Century, you might need to change the IP address to **192.168.20.14**. 
...
This device is `Century Hardware Development Platform Supported`
