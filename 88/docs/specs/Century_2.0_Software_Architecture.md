# Century 2.0 Software Architecture



Core software modules running on the Century 2.0 powered autonomous vehicle include:
...
![img](https://github.com/CenturyAuto/century/blob/master/docs/specs/images/Century_2_0_Software_Arch.png)
