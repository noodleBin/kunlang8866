# Century 3.0 Software Architecture

Core software modules running on the Century 3.0 powered autonomous vehicle include:
...
- **HMI** - Human Machine Interface or DreamView in Century is a module for viewing the status of the vehicle, testing other modules and controlling the functioning of the vehicle in real-time.
...
![img](https://github.com/CenturyAuto/century/blob/master/docs/specs/images/prediction.png)
...
![img](https://github.com/CenturyAuto/century/blob/master/docs/specs/images/localization.png)
...
![img](https://github.com/CenturyAuto/century/blob/master/docs/specs/images/localization_2.png)
...
![img](https://github.com/CenturyAuto/century/blob/master/docs/specs/images/routing.png)

## Planning

Century 2.0 uses several information sources to plan a safe and collision free trajectory, so the planning module interacts with almost every other module.
...
![img](https://github.com/CenturyAuto/century/blob/master/docs/specs/images/planning_1.png)

The data dependencies such as chassis, localization, traffic light, and prediction are managed through the `AdapterManager` class. The core software modules are similarly managed.  For example, localization is managed through `AdapterManager::GetLocalization()` as shown below.![img](https://github.com/CenturyAuto/century/blob/master/docs/specs/images/planning_2.png)
...
![img](https://github.com/CenturyAuto/century/blob/master/docs/specs/images/control_1.png)
...
![img](https://github.com/CenturyAuto/century/blob/master/docs/specs/images/control_2.png)

## CanBus

The CanBus has two data interfaces as shown below.

![img](https://github.com/CenturyAuto/century/blob/master/docs/specs/images/canbus_1.png)
...
![img](https://github.com/CenturyAuto/century/blob/master/docs/specs/images/canbus_2.png)
...
## HMI
 ...
 Human Machine Interface or DreamView in Century is a web application that:
