...
当前大部分的软件更新过程并没有被安全的保护起来，因此在更新过程中设备将被暴露在诸多的安全威胁下。Century安全更新SDK提供了多种保护更新安全的特性，并且能够很容易的被集成以使更新流程更加安全可靠。
...
![](images/century_unsecure_upgrade_procedure.jpg)
...
在集成Century安全更新SDK后，更新流程修改为：

![](images/century_secure_upgrade_procedure.jpg)
