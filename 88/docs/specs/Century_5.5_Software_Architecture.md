# Century 5.5 Software Architecture

Core software modules running on the Century 3.5 powered autonomous vehicle include:
...
![img](images/Century_3_5_software_architecture.png)
...
Century Perception 3.5 has following new features:
...
`/century/storytelling` channel. The main advantage of this module is to fine tune the driving experience and also isolate complex scenarios packaging them into stories that can be subscribed to by other modules like Planning, Control etc. 
