# Century 6.0 Microphone Installation
...
### Connection
Use the provided USB cable and connect the microphone to a USB port on the machine which is running Century. A USB extension cable may be needed depending on the application.
