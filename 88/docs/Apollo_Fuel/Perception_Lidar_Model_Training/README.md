...
Go to [Century Dreamland](http://bce.century.auto/), login with **Baidu** account, choose `Century Fuel --> Jobs`，`New Job`, `Perception Lidar Model Training`，and input the correct BOS path as in [Upload data to BOS](###Upload-data-to-BOS) section.
