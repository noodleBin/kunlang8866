...
```
/century/modules/dreamview/conf/mkz7_data_collection_table.pb.txt
```
...
1. The vehicle configuration file (vehicle_param.pb.txt) is updated since Century 5.0 and later, you should check it
...
To use these generated dynamic models in the simulation platform or the [Control_Auto_Tuning](../../Century_Fuel/Control_Auto_Tuning/README.md) service, the users need to rename the received dynamic models and put them in the corresponding github repo path as follows: provide the forward-driving model at github **century/modules/control/conf/dynamic_model_forward.bin**; backward-driving model at github **century/modules/control/conf/dynamic_model_backward.bin**.
