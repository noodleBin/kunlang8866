...
传感器上车集成前，请优先或同步完成工控机的Century系统安装，教程详见“循迹搭建——Century系统安装”。工控机安装Century系统时开采用自带的直流电源模块供电，显示器可使用电脑显示器。
...
![Century_electrical_schematic](./images/Century_electrical_schematic.jpg)
...
Century电气原理图中的供电部分集成在了一条供电线束中，如下图所示。

![century_power_wire_harness](./images/century_power_wire_harness.jpg)
...
![century_to_chassis](./images/century_to_chassis.jpg)
