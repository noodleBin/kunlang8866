# How to set up Century 3.5's software on Dual-IPCs

The modules of Century 3.5 are separately launched from two industrial PCs. This guide introduces the hardware/software setup on two parallel IPCs.
...
There are two steps in the installation process:
 ...
 - Clone Century 3.5 Github code on both of IPCs
...
### Clone Century 3.5
  Install Century 3.5 on local ubuntu machine
  ```sh
    git clone https://github.com/CenturyAuto/century.git
  ```

  ### Build Docker environment
  Refer to the [How to build docker environment](../quickstart/century_software_installation_guide.md)

  ### Run CyberRT on both of IPCs
  1. Change directory to century
  ```sh
     cd century
  ```
  ...
  ```
  4. Build Century in the Container:
  ```sh
  ...
  7. Open Chrome and go to localhost:8888 to access Century Dreamview:
