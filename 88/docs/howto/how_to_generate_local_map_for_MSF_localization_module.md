...
## Prerequisites
 ...
 - ~~Download localization data from the [Multi-Sensor Fusion Localization Data](http://data.century.auto/help?name=sensor%20data&data_key=multisensor&data_type=1&locale=en-us&lang=en)（US only).~~
...
In the downloaded data, look for a folder named *century3.5*. Let's assume the path of this folder to be DATA_PATH.
