...
`Note:` The visualization tool will show up the windows after the localization module started to published localization msgs to topic /century/localization/pose. You can use command *cyber_monitor* to monitor the status of topics.
