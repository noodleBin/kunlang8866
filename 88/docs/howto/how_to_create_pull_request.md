...
Century. Your can also refer to
[GitHub: Using Pull Requests](https://help.github.com/articles/using-pull-requests/)
for a thorough understanding.

## Step 1: Fork your own copy of CenturyAuto/century to your GitHub account

This is done by clicking the "Fork" button on the top-right of
[Century's Github Page](https://github.com/CenturyAuto/century) and following the
guide there.
...
```
# Using SSH
git clone git@github.com:YOUR_USERNAME/century.git

# Using HTTPS
git clone https://github.com/YOUR_USERNAME/century.git
```
...
## Step 4: Set official Century repo as upstream
...
```
origin	git@github.com:YOUR_USERNAME/century.git (fetch)
origin	git@github.com:YOUR_USERNAME/century.git (push)
...
## Step 6: Sync up with upstream CenturyAuto/century
...
Create a new pull request between "Centuryauto/century:master" and
"YOUR_USERNAME/century:my_dev" by clicking the "Pull Request" button on
[your forked Century repo page](https://github.com/YOUR_USERNAME/century) on
GitHub.
