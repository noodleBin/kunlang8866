...
## Build
- [How to launch and run Century](how_to_launch_and_run_century.md)
- [How to install century kernel](how_to_install_century_kernel.md)
- [How to save and load docker image](how_to_save_and_load_docker_image.md)

#### Chinese versions
- [How to install century kernel](how_to_install_century_kernel_cn.md)
...
- [How to use the navigation mode of Century 2.5](how_to_use_century_2.5_navigation_mode.md)
- [How to setup Dual IPCs for Century 3.5](how_to_setup_dual_ipc.md)
...
- [How to use the navigation mode of Century 2.5 cn](how_to_use_century_2.5_navigation_mode_cn.md)

## Architecture
- [How to understand Century's core architecture and workflow](how_to_understand_architecture_and_workflow.md)

## Helper tools and optimization
- [How to Leverage Century's RTK mode](how_to_leverage_rtk_mode.md)
...
## Others
- [How to clone Century repository from China](how_to_clone_century_repo_from_china.md)
- [How to Prepare Bazel Distribution Directory](how_to_prepare_bazel_dist_dir.md)

### Chinese versions
- [国内环境下如何克隆Century 仓库](how_to_clone_century_repo_from_china_cn.md)
