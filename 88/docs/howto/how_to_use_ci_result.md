# How to Use CI Result in Century

In Century, whether a PR can be merged depends on CI result and CLA.

## What works will CI check?

Century CI will run the following steps:

1. Checkout your PR into Century codebase and build
...
This is due to lint error. Century adopted Google coding style, so the header
