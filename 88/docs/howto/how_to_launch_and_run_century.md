...
# loaded. If no GPU is availabe, please run "./century.sh build_opt" instead.
./century.sh build_opt_gpu
```

**Note**:

> Please run `./century.sh build_fe` before `./century.sh build_opt` if you made
> any modifications to the Dreamview frontend.

## Run Century

Once you have finished building Century, follow the steps below to launch it.
...
![Access Dreamview](images/century_bootstrap_screen.png)
...
You have successfully built Century! Now you can revisit
[Century Readme](../../README.md) for additional guidelines on the neccessary
hardware setup.
