...
Simulation plays a central role in Century’s internal development cycle.
...
So far Century simulation allowed external users to access over 200 sample
...
support Scenario Creation and Editing which the Century team now proudly presents
in Century 5.0!
...
2. Once inside the platform, the Scenario Editor can be accessed under
   ...
   [following link](https://azure.century.auto/scenario-management/scenario-editor)
