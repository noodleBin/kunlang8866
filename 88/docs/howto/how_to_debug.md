# How to Debug Century

## Debugging Century

The Century project runs in Docker and cannot be used directly on the host
...
When compiling Century projects, you will need to use debugging information
...
During the R&D process, we also need to debug the Century project remotely on the
...
```bash
# Switch to the Century project root directory on the industrial computer
cd ~/code/century
