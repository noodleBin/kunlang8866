...
The default CAN card used in Century is the **ESD CAN-PCIe card**. You can add a new CAN card using the steps below:
...
/**
 * @namespace century::canbus::can
 * @brief century::canbus::can
 */
namespace century {
namespace canbus {
namespace can {
...
class ExampleCanClient : public CanClient {
 public:
   ...
   *         century::common::ErrorCode.
   */
  century::common::ErrorCode Start() override;
   ...
   *         century::common::ErrorCode.
   */
  century::common::ErrorCode Send(const std::vector<CanFrame>& frames,
   ...
   *         century::common::ErrorCode.
   */
  century::common::ErrorCode Receive(std::vector<CanFrame>* const frames,
                                    int32_t* const frame_num) override;
...
If you use radar, like Conti radar in century, its' canbus configuration file should alse be modified. Update `/modules/drivers/radar/conti_radar/conf/conti_radar_conf.pb.txt`
