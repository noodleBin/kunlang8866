...
Low-Latency/Realtime kernel is only required for running Century software stack
in the vehicle. If your sole purpose was to develop/test your algorithms or to
run simulation software (e.g., LGSVL simulator) on top of Century, then maybe you
...
of low- to no- latency for running Century in the vehicle. Preempt optimization
...
[instructions](https://github.com/CenturyAuto/century-kernel/blob/master/linux/ESDCAN-README.md)
