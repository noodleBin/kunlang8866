...
###############################################################################
"""
A script for downloading Century record files
"""
...
DOWNLOAD_LINK_PREFIX = "https://github.com/CenturyAuto/century/releases/download"

URL_LISTING = [
    "v1.0.0/demo_1.0.bag",
    "v1.5.0/demo_1.5.bag",
    "v2.0.0/demo_2.0.bag",
    "v2.0.0/century_2.0_camera_sample.bag",
    "v2.5.0/demo_2.5.bag",
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="A script for downloading Century demo records")
    parser.add_argument(
        "name",
        type=str,
        help=name_desc)
