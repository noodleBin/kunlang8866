...
class CanReceiver {
 public:
   ...
   */
  ::century::common::ErrorCode Start();
...
template <typename SensorType>
::century::common::ErrorCode CanReceiver<SensorType>::Init(
  ...
  if (can_client_ == nullptr) {
    ...
    return ::century::common::ErrorCode::CANBUS_ERROR;
  }
  ...
  is_init_ = true;
  return ::century::common::ErrorCode::OK;
}
...
template <typename SensorType>
::century::common::ErrorCode CanReceiver<SensorType>::Start() {
  if (is_init_ == false) {
    return ::century::common::ErrorCode::CANBUS_ERROR;
  }
