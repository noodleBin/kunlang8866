...
class ContiRadarCanbusComponent : public century::cyber::Component<> {
 public:
 ...
 private:
  ...
  century::drivers::canbus::CanReceiver<ContiRadar> can_receiver_;
  ...
  std::shared_ptr<
      ...
      pose_reader_;
  void PoseCallback(
      const std::shared_ptr<century::localization::LocalizationEstimate>& pose);
