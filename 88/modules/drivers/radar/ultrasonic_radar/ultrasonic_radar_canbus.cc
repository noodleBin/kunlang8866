...
/**
 * @namespace century::drivers::ultrasonic_radar
...
century::common::Status UltrasonicRadarCanbus::Init(
    const std::string& config_path,
    const std::shared_ptr<::century::cyber::Writer<Ultrasonic>>& writer) {
...
century::common::Status UltrasonicRadarCanbus::Start() {
