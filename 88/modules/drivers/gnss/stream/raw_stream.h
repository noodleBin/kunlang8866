...
class RawStream {
 ...
 private:
  ...
  std::shared_ptr<century::canbus::Chassis> chassis_ptr_ = nullptr;
  ...
  std::shared_ptr<century::cyber::Writer<StreamStatus>> stream_writer_ = nullptr;
  std::shared_ptr<century::cyber::Writer<RawData>> raw_writer_ = nullptr;
  std::shared_ptr<century::cyber::Writer<RawData>> rtcm_writer_ = nullptr;
  std::shared_ptr<century::cyber::Reader<RawData>> gpsbin_reader_ = nullptr;
