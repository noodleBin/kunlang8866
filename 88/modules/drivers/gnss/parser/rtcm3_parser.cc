...
void Rtcm3Parser::FillKepplerOrbit(
    const eph_t &eph, century::drivers::gnss::KepplerOrbit *keppler_orbit) {
...
void Rtcm3Parser::FillGlonassOrbit(const geph_t &eph,
                                   century::drivers::gnss::GlonassOrbit *orbit) {
  ...
  orbit->set_gnss_time_type(century::drivers::gnss::GnssTimeType::GPS_TIME);
...
void Rtcm3Parser::SetObservationTime() {
  ...
  observation_.set_gnss_time_type(century::drivers::gnss::GPS_TIME);
...
bool Rtcm3Parser::ProcessEphemerides() {
  ...
  if (gnss_type == century::drivers::gnss::GnssType::GLO_SYS) {
