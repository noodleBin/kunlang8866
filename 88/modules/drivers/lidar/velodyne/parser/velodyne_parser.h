...
using century::drivers::PointXYZIT;
using century::drivers::velodyne::DUAL;
using century::drivers::velodyne::HDL32E;
using century::drivers::velodyne::HDL64E_S2;
using century::drivers::velodyne::HDL64E_S3D;
using century::drivers::velodyne::HDL64E_S3S;
using century::drivers::velodyne::LAST;
using century::drivers::velodyne::STRONGEST;
using century::drivers::velodyne::VelodynePacket;
using century::drivers::velodyne::VelodyneScan;
using century::drivers::velodyne::VLP16;
using century::drivers::velodyne::VLP32C;
using century::drivers::velodyne::VLS128;
