...
DEFINE_string(kv_db_path, "/century/data/kv_db.sqlite",
              "Path to Key-value DB file.");
#elif defined(__aarch64__)
DEFINE_string(kv_db_path, "/home/nvidia/workspace/vehicle_config/kv_db.sqlite",
              "Path to Key-value DB file.");
#endif
