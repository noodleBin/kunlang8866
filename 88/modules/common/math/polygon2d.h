...
/**
 * @namespace century::common::math
 * @brief century::common::math
 */
namespace century {
namespace common {
namespace math {
...
class Polygon2d {
 public:
  ...
  std::vector<Vec2d> &no_const_points() { return points_; }

  const std::vector<Vec2d> GetAllPoints() const;

/**
 * @brief insert a point to polygon
 * @point the point to be insert
 */
   ...
   * the calculation is simple and practical enough.
   * @param distance The specified distance. To expand this polygon by it.
   * @return The polygon after expansion.
   */
  Polygon2d ExpandByDistance(const double distance,
