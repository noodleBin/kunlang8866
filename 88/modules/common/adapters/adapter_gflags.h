...
DECLARE_string(perception_around_ego_obstacle_topic);
...
DECLARE_string(udas_ultrasonic_topic);
DECLARE_string(udas_ultrasonic_eol_topic);
DECLARE_string(cubtek_radar_topic);
DECLARE_string(cubtek_radar_eol_topic);
DECLARE_string(lgrx_radar_topic);
DECLARE_string(movex_radar_topic);
DECLARE_string(microbrain_radar_topic);
DECLARE_string(localization_delay_topic);
DECLARE_string(mems_status_topic);
// system monitor topic
DECLARE_string(system_monitor_x86_topic);
DECLARE_string(system_monitor_aarch_topic);
DECLARE_string(dreamview_topic);
DECLARE_string(imu_raw_topic);
DECLARE_string(mcloud_info_topic);
DECLARE_string(tracker_mems_topic);
DECLARE_string(tracker_radar_topic);
DECLARE_string(tracker_rs_topic);
DECLARE_string(tracker_ultrasonic_topic);
DECLARE_string(tracker_camera_topic);
DECLARE_string(front_12mm_status_topic);
DECLARE_string(front_3mm_status_topic);
DECLARE_string(back_3mm_status_topic);
DECLARE_string(control_request_topic);
DECLARE_string(fas_aeb_info_topic);
DECLARE_string(emergency_stop_topic);
