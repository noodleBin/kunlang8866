...
void GnssMagTransfer::Transfer(const century::drivers::gnss::BandObservation& in,
...
void GnssMagTransfer::Transfer(
    const century::drivers::gnss::SatelliteObservation& in,
...
void GnssMagTransfer::Transfer(
    const century::drivers::gnss::EpochObservation& in,
...
void GnssMagTransfer::Transfer(const century::drivers::gnss::KepplerOrbit& in,
                               KepplerOrbitMsg* out) {
  CHECK_NOTNULL(out);
  if (in.has_gnss_type()) {
...
void GnssMagTransfer::Transfer(const century::drivers::gnss::GlonassOrbit& in,
                               GlonassOrbitMsg* out) {
  CHECK_NOTNULL(out);
  if (in.has_gnss_type()) {
    out->set_gnss_type(GnssType(in.gnss_type()));
...
void GnssMagTransfer::Transfer(const century::drivers::gnss::GnssEphemeris& in,
