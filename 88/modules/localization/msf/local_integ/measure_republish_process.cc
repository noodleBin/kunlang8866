...
void MeasureRepublishProcess::GnssLocalProcess(
  ...
  century::localization::msf::FrameTransform::XYZToBlh(pos_xyz, &pos_blh);
...
bool MeasureRepublishProcess::LidarLocalProcess(
  ...
  century::localization::msf::WGS84Corr temp_wgs;
  century::localization::msf::FrameTransform::UtmXYToLatlon(
