...
using century::perception::base::CameraObjectSupplement;
using century::perception::base::FusionObjectSupplement;
using century::perception::base::ObjectSubType;
using century::perception::base::ObjectType;
using century::perception::base::SensorType;
