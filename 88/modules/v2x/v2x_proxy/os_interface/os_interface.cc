...
using ::century::v2x::IntersectionTrafficLightData;

OsInterFace::OsInterFace()
    : node_(::century::cyber::CreateNode("v2x_os_interface")),
      init_flag_(false) {
...
bool OsInterFace::InitWriters() {
  v2x_obu_traffic_light_writer_ =
      node_->CreateWriter<::century::v2x::obu::ObuTrafficLight>(
          FLAGS_v2x_obu_traffic_light_topic);
  v2x_traffic_light_writer_ =
      node_->CreateWriter<::century::v2x::IntersectionTrafficLightData>(
          FLAGS_v2x_traffic_light_topic);
  v2x_traffic_light_hmi_writer_ =
      node_->CreateWriter<::century::perception::TrafficLightDetection>(
          FLAGS_v2x_traffic_light_for_hmi_topic);
  v2x_obstacles_internal_writer_ =
      node_->CreateWriter<century::v2x::V2XObstacles>(
