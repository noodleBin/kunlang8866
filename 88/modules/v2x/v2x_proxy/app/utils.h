...
class InternalData final {
 ...
 public:
  ...
  bool TrafficLightProc(const std::shared_ptr<::century::hdmap::HDMap> &hdmap,
                        double distance, ::century::v2x::RoadTrafficLight *msg);

  bool ProcTrafficlight(const std::shared_ptr<::century::hdmap::HDMap> &hdmap,
