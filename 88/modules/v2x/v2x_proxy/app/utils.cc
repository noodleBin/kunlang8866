...
bool InternalData::TrafficLightProc(
    const std::shared_ptr<::century::hdmap::HDMap> &hdmap, double distance,
    ::century::v2x::RoadTrafficLight *msg) {
  if (nullptr == msg) {
    return false;
  }
  ...
  ::century::hdmap::LaneInfoConstPtr laneinfo;
  double dummy_s = 0, dummy_l = 0;
  if (0 != hdmap->GetNearestLane(point, &laneinfo, &dummy_s, &dummy_l)) {
    return false;
  }
  std::vector<::century::hdmap::SignalInfoConstPtr> signals;
...
bool InternalData::ProcTrafficlight(
    const std::shared_ptr<::century::hdmap::HDMap> &hdmap,
  ...
  oslight_ = std::make_shared<::century::v2x::IntersectionTrafficLightData>();
...
bool InternalData::ProcPlanningMessage(
    const ::century::planning::ADCTrajectory *planning_msg,
    const OSLight *last_os_light,
    std::shared_ptr<::century::perception::TrafficLightDetection> *res_light) {
  ...
  ::century::common::Direction attr = ::century::common::Direction::EAST;
  bool found = false;
  ...
  AINFO << "Selected road attr: " << ::century::common::Direction_Name(attr);
    ...
    if (single_tl.has_color()) {
      switch (single_tl.color()) {
        case OSLightColor::SingleTrafficLight_Color_RED:
          light1->set_color(
              ::century::perception::TrafficLight_Color::TrafficLight_Color_RED);
          break;
        case OSLightColor::SingleTrafficLight_Color_YELLOW:
          light1->set_color(::century::perception::TrafficLight_Color::
...
namespace utils {
bool FindAllRoadId(const std::shared_ptr<::century::hdmap::HDMap> &hdmap,
                   const ::century::hdmap::LaneInfoConstPtr &start_laneinfo,
                   const ::century::hdmap::LaneInfoConstPtr &end_laneinfo,
  ...
  ::century::hdmap::LaneInfoConstPtr start_laneinfo_tmp = start_laneinfo;
  while (true) {
...
bool CheckCarInSet(const std::shared_ptr<::century::hdmap::HDMap> &hdmap,
                   const std::unordered_set<std::string> &id_set,
                   const ::century::hdmap::LaneInfoConstPtr &car_laneinfo,
...
bool GetRsuInfo(const std::shared_ptr<::century::hdmap::HDMap> &hdmap,
                const OSLocation &os_location,
                const std::set<std::string> &rsu_whitelist, double distance,
                double max_heading_difference,
                std::shared_ptr<::century::v2x::CarStatus> *v2x_car_status,
  ...
  *out_junction_id = kUnknownJunctionId;
  auto res = std::make_shared<::century::v2x::CarStatus>();
  if (nullptr == res) {
    return false;
  }
  ...
  *out_heading = heading;
  std::vector<::century::hdmap::RSUInfoConstPtr> rsus;
  ...
  std::shared_ptr<::century::v2x::ObuJunction> obu_junction = nullptr;
