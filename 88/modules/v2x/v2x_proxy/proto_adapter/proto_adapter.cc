...
bool ProtoAdapter::LightObu2Sys(const ObuLight &obu_light,
  ...
  for (int idx_road = 0; idx_road < obu_light.road_traffic_light_size();
    ...
    century::common::Direction tl_attr = century::common::Direction::EAST;
    switch (obu_road_light1.road_direction()) {
      case 1:
        tl_attr = century::common::Direction::EAST;
        break;
      case 2:
        tl_attr = century::common::Direction::WEST;
        break;
      case 3:
        tl_attr = century::common::Direction::SOUTH;
        break;
      case 4:
        tl_attr = century::common::Direction::NORTH;
        break;
      default:
