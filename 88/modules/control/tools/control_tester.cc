...
DEFINE_string(
    chassis_test_file,
    "/century/modules/control/testdata/control_tester/chassis.pb.txt",
    "Used for sending simulated Chassis content to the control node.");
DEFINE_string(
    localization_test_file,
    "/century/modules/control/testdata/control_tester/localization.pb.txt",
    "Used for sending simulated localization to the control node.");
DEFINE_string(pad_msg_test_file,
              "/century/modules/control/testdata/control_tester/pad_msg.pb.txt",
              "Used for sending simulated PadMsg content to the control node.");
DEFINE_string(
    planning_test_file,
    "/century/modules/control/testdata/control_tester/planning.pb.txt",
...
int main(int argc, char** argv) {
  ...
  std::shared_ptr<century::cyber::Node> node(
      century::cyber::CreateNode("control_tester"));
