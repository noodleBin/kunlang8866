...
typedef century::localization::msf::pyramid_map::NdtMap NdtMap;
typedef century::localization::msf::pyramid_map::NdtMapConfig NdtMapConfig;
typedef century::localization::msf::pyramid_map::NdtMapNode NdtMapNode;
typedef century::localization::msf::pyramid_map::NdtMapCells NdtMapCells;
typedef century::localization::msf::pyramid_map::NdtMapNodePool NdtMapNodePool;
typedef century::localization::msf::pyramid_map::NdtMapMatrix NdtMapMatrix;
typedef century::localization::msf::pyramid_map::MapNodeIndex MapNodeIndex;
...
TEST_F(NdtSolverTestSuite, NdtSolver) {
  ...
  const std::string input_source_file =
      "/century/modules/localization/ndt/test_data/pcds/1.pcd";
  int ret = pcl::io::loadPCDFile(input_source_file, *cloud_source);
  EXPECT_LE(ret, 0);

  // Load input target.
  const std::string map_folder =
      "/century/modules/localization/ndt/test_data/ndt_map";
  std::list<MapNodeIndex> buf;
