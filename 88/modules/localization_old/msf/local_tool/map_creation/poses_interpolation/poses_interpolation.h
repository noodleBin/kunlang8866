...
/**
 * @namespace century::localization
 * @brief century::localization
 */
namespace century {
...
class PosesInterpolation {
 ...
 private:
  ...
  void PoseInterpolationByTime(
      const ::century::common::EigenAffine3dVec &in_poses,
      ...
      ::century::common::EigenAffine3dVec *out_poses);
 ...
 private:
  ...
  ::century::common::EigenAffine3dVec input_poses_;
  ...
  ::century::common::EigenAffine3dVec out_poses_;
};
