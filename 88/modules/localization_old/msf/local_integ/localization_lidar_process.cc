...
using century::common::util::Timer;
...
int LocalizationLidarProcess::GetResult(LocalizationEstimate* lidar_local_msg) {
  ...
  century::common::Header* headerpb = lidar_local_msg->mutable_header();
  headerpb->set_timestamp_sec(pre_location_time_);

  century::localization::Pose* posepb = lidar_local_msg->mutable_pose();
