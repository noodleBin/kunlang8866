...
class LocalizationLidar {
 public:
  typedef century::localization::msf::pyramid_map::PyramidMap PyramidMap;
  typedef century::localization::msf::pyramid_map::MapNodeIndex MapNodeIndex;
  typedef century::localization::msf::pyramid_map::PyramidMapNode PyramidMapNode;
  typedef century::localization::msf::pyramid_map::PyramidMapNodePool
      PyramidMapNodePool;
  typedef century::localization::msf::pyramid_map::PyramidMapMatrix
      PyramidMapMatrix;
  typedef century::localization::msf::pyramid_map::PyramidMapConfig
      PyramidMapConfig;
  typedef century::localization::msf::pyramid_map::FloatMatrix FloatMatrix;
  typedef century::localization::msf::pyramid_map::UIntMatrix UIntMatrix;
