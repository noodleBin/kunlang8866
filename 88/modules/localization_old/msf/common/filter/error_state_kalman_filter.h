...
constexpr double K_ZERO_VEL_MEASUREMENT_NOISE = 1.0e-4;
...
class ErrorStateKalmanFilter : public KalmanFilter {
 ...
 private:
  ...
  bool ApplyMeasurementZeroVel(StateNodeBuffer::iterator& node_curr,
 ...
 private:
  ...
  MatrixRVel RZeroVel_ = MatrixRVel::Zero();
