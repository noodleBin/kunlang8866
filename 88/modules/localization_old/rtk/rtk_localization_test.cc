...
TEST_F(RTKLocalizationTest, ComposeLocalizationMsg) {
  {
    ...
    century::localization::LocalizationEstimate expected_result;
    load_data("modules/localization/testdata/3_localization_result_2.pb.txt",
              &expected_result);

    century::localization::LocalizationEstimate localization;
