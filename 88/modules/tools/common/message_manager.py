...
topic_pb_list = [
    MessageType("audio_event", "/century/audio_event",
                    audio_event_pb2.AudioEvent),
    MessageType("planning", "/century/planning", planning_pb2.ADCTrajectory),
    MessageType("control", "/century/control", control_cmd_pb2.ControlCommand),
    MessageType("chassis", "/century/canbus/chassis", chassis_pb2.Chassis),
    MessageType("prediction", "/century/prediction",
                prediction_obstacle_pb2.PredictionObstacles),
    MessageType("perception", "/century/perception/obstacles",
                perception_obstacle_pb2.PerceptionObstacles),
    MessageType("routing_response", "/century/routing_response",
                routing_pb2.RoutingResponse),
    MessageType("routing_request", "/century/routing_request",
                routing_pb2.RoutingRequest),
    MessageType("localization", "/century/localization/pose",
                localization_pb2.LocalizationEstimate),
    MessageType("traffic_light", "/century/perception/traffic_light",
                traffic_light_detection_pb2.TrafficLightDetection),
    MessageType("drive_event", "/century/drive_event",
                drive_event_pb2.DriveEvent),
    MessageType("relative_map", "/century/relative_map", navigation_pb2.MapMsg),
    MessageType("navigation", "/century/navigation",
                navigation_pb2.NavigationInfo),
    MessageType("guardian", "/century/guardian", guardian_pb2.GuardianCommand),
]
