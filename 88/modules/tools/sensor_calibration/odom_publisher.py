...
class OdomPublisher(object):
    def __init__(self, node):
        ...
        self.gps_odom_pub = node.create_writer('/century/sensor/gnss/odometry', gps_pb2.Gps) 
        self.sequence_num = 0
...
def main():
    ...
    node.create_reader('/century/localization/pose', localization_pb2.LocalizationEstimate, odom.localization_callback)
