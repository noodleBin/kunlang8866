...
def select_static_image_pcd(path, min_distance=5, stop_times=5,
    ...
    come from /centurylocalization/pose as well
    """
    subfolders = [x for x in get_subfolder_list(
        path) if '_century_sensor_' in x or '_localization_pose' in x]
...
def main2():
    for str in ['_century_sensor_lidar16_front_center_PointCloud2',
                '_century_sensor_lidar16_rear_left_PointCloud2',
                '_century_sensor_lidar16_rear_right_PointCloud2',
                '_century_sensor_lidar128_PointCloud2']:
         # _century_sensor_lidar128_PointCloud2'
        in_path = '/century/data/Lidar_GNSS_Calibration-2019-07-12-15-25/' + str
    ...
    in_path = '/century/data/Lidar_GNSS_Calibration-2019-07-12-15-25/_century_sensor_gnss_odometry'
    out_path = os.path.join(in_path, 'new')
    mkdir_p(out_path)
    timestamp_filename = 'timestamps.txt'
    extension = 'odometry'
