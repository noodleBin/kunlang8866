...
random.seed(99999)
rand_num = 1000
original_file_path = "/century/modules/planning/conf/planner_open_space_config.pb.txt"
optimal_file_path = "/century/modules/planning/conf/optimal_planner_open_space_config_-8_4.pb.txt"
