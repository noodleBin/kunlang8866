    ...
    if r.status_code == 200:
        ...
        if auth_token == "":
            ...
            token_file_name = os.environ['HOME'] + \
                '/.cache/century_update/auth_token'
            century_update = os.path.dirname(token_file_name)
            if not os.path.exists(century_update):
                os.makedirs(century_update)
