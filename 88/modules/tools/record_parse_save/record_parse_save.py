...
"""
function to parse data from *.record files, created using Century-Auto
...
def parse_century_record(parse_dict, dest_dict, parser_func):
    """
    """
...
if __name__ == '__main__':
    ...
    parse_century_record(parse_dict, dest_dict, parser_func)
