## Century cyber-record file parser (Python based)
...
Century (`/century/cyber/python/examples/`).
...
- [`parser_params.yaml`](./parser_params.yaml): YAML file with details of
  ...
  - list of channels in a record-file can be obtained using
    ...
    `/century/data/record_files/2019-04-22-14-27-05/2019-04-22-14-27-05_records/`
    enter following at command prompt:
    - `cyber_recorder info /century/data/record_files/2019-04-22-14-27-05/2019-04-22-14-27-05_records/20190422142705.record.00000`
...
- It is assumed that the user is within Century docker environment and has
  successfully built it. Please check documentation on
  [Build Century](../../../docs/howto/how_to_launch_and_run_century.md) if
  required.
