...
Inside docker, run the following command from your Century root dir:
...
can be found in your Century root dir.
...
Inside docker, run the following command from Century root dir:
```
