...
CHASSIS_CHANNEL = '/century/canbus/chassis'
LOCALIZATION_CHANNEL = '/century/localization/pose'
...
def sanity_check(input_folder):
    ...
    if file_flag:
        ...
        err_msg = (
            'Messages are missing in records channels century/chassis or '
            f'century/localization/pose, records are {channel_result}')
    else:
