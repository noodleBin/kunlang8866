...
flags.DEFINE_string('data_path', '/century/output', 'Default output data path')
flags.DEFINE_string('calibration_data_path',
                    '/century/modules/calibration/data',
...
flags.DEFINE_string('record_root_path', '/century/data/bag',
