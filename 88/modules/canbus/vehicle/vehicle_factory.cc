...
void VehicleFactory::RegisterVehicleFactory() {
  Register(century::common::LINCOLN_MKZ, []() -> AbstractVehicleFactory * {
    return new LincolnVehicleFactory();
  });
  Register(century::common::GEM, []() -> AbstractVehicleFactory * {
    return new GemVehicleFactory();
  });
  Register(century::common::LEXUS, []() -> AbstractVehicleFactory * {
    return new LexusVehicleFactory();
  });
  Register(century::common::TRANSIT, []() -> AbstractVehicleFactory * {
    return new TransitVehicleFactory();
  });
  Register(century::common::GE3, []() -> AbstractVehicleFactory * {
    return new Ge3VehicleFactory();
  });
  Register(century::common::WEY, []() -> AbstractVehicleFactory * {
    return new WeyVehicleFactory();
  });
  Register(century::common::ZHONGYUN, []() -> AbstractVehicleFactory * {
    return new ZhongyunVehicleFactory();
  });
  Register(century::common::CH, []() -> AbstractVehicleFactory * {
    return new ChVehicleFactory();
  });
  Register(century::common::DKIT, []() -> AbstractVehicleFactory * {
    return new DevkitVehicleFactory();
  });
  Register(century::common::NEOLIX, []() -> AbstractVehicleFactory * {
