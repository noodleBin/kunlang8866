...
class Ge3Controller final : public VehicleController {
 ...
 private:
  ...
  ::century::common::ErrorCode EnableAutoMode() override;
  ::century::common::ErrorCode DisableAutoMode() override;
  ::century::common::ErrorCode EnableSteeringOnlyMode() override;
  ::century::common::ErrorCode EnableSpeedOnlyMode() override;
  ...
  void SetEpbBreak(const ::century::control::ControlCommand& command) override;
  void SetBeam(const ::century::control::ControlCommand& command) override;
  void SetHorn(const ::century::control::ControlCommand& command) override;
  void SetTurningSignal(
      const ::century::control::ControlCommand& command) override;

  void ResetProtocol();
  bool CheckChassisError();
  bool CheckSafetyError(const canbus::ChassisDetail& chassis);
  void SetWheelSpeed(const Ge3& ge3);
  void SetVin(const Ge3& ge3);
