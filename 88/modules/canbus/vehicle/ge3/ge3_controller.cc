...
Chassis Ge3Controller::chassis() {
  ...
  if (ge3.has_scu_epb_310() && ge3.scu_epb_310().has_epb_sysst()) {
    chassis_.set_parking_brake(Scu_epb_310::EPB_SYSST_APPLIED ==
                               ge3.scu_epb_310().epb_sysst());
  } else {
...
void Ge3Controller::SetWheelSpeed(const Ge3& ge3) {
...
void Ge3Controller::SetVin(const Ge3& ge3){
...
bool Ge3Controller::CheckChassisError() {
  ...
  if (ge3.has_scu_eps_311()) {
    if (ge3.scu_eps_311().eps_faultst() == Scu_eps_311::EPS_FAULTST_FAULT) {
      return true;
    }
  }
