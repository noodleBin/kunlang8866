...
DEFINE_string(canbus_conf_file,
 "/century/modules/canbus/conf/canbus_conf.pb.txt",
...
DEFINE_string(canbus_test_file,
              "/century/modules/canbus/testdata/canbus_test.pb.txt",
...
DEFINE_bool(enable_monitor_control, true,
            "Enable stop when control input lossed");

DEFINE_bool(enable_canbus_thread, true,
            "Enable canbus thread.");

DEFINE_bool(enable_canbus_debug_flag, false,
            "Enable canbus debug flag.");
