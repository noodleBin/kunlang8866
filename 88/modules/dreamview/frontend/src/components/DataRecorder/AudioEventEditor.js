...
const AUDIO_TYPE = simWorldRoot.lookup('century.audio.AudioType').values;
const AUDIO_DIRECTION = simWorldRoot.lookup('century.audio.AudioDirection').values;
const MOVING_RESULT = simWorldRoot.lookup('century.audio.MovingResult').values;
