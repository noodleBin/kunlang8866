...
import EditScenarioSetting from 'components/SimulateEditingBar/EditScenarioSetting';
import DemonstrateSetting from 'components/Layouts/DemonstrateSetting';

export default class MonitorPanel extends React.Component {
  renderMonitor() {
    const { viewName, vehicleConfig, allVehicleConfig } = this.props;
    ...
    switch (viewName) {
      ...
      case MONITOR_MENU.FUEL_CLIENT:
        return <FuelClient />;
      case MONITOR_MENU.EDIT_SCENARIO:
        return <EditScenarioSetting />;
      case MONITOR_MENU.DEMONSTRATE:
        return (
          <DemonstrateSetting
            vehicleConfig={vehicleConfig}
            allVehicleConfig={allVehicleConfig}
          />
        );
      default:
        return null;
