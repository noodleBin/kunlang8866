...
This folder contains modes configuration for Century vehicle. Each pb.txt should
...
[handle new channels](https://github.com/CenturyAuto/century/blob/master/modules/monitor/software/channel_monitor.cc#L51).
