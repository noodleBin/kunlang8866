...
DEFINE_string(static_file_dir, "/century/modules/dreamview/frontend/dist",
              "The path to the dreamview distribution directory. The default "
              "value points to built-in version from the Century project.");
...
DEFINE_double(sim_map_radius, 20000.0,
...
DEFINE_string(lidar_height_yaml,
              "/century/modules/localization/msf/params/velodyne_params/"
...
DEFINE_string(default_data_collection_config_path,
              "/century/modules/dreamview/conf/data_collection_table.pb.txt",
...
DEFINE_string(default_preprocess_config_path,
              "/century/modules/dreamview/conf/preprocess_table.pb.txt",
...
DEFINE_string(dynamic_file_path, "/century/modules/dreamview/conf/dynamic_conf.json",
              "dynamic file path");

DEFINE_string(record_cmd_topic, "/century/dreamview/record/cmd",
              "Record command topic.");

DEFINE_string(record_status_topic, "/century/dreamview/record/status",
              "Record status topic.");

DEFINE_string(barrier_command_topic, "/century/barrier_command",
              "Barrier command topic.");

DEFINE_int32(barrier_command_publish_interval_ms, 100,
             "Barrier command periodic publish interval in milliseconds.");

DEFINE_double(barrier_command_auto_stop_seconds, 3.0,
              "Barrier command auto stop time in seconds.");

DEFINE_string(barrier_command_password, "admin",
              "Barrier command confirmation password.");
