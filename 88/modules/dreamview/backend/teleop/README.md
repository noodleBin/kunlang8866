...
- When "Stop" button is clicked, a pad message with `DrivingAction` of `STOP`, defined by Protobuf message `PadMessage` in [pad_msg.proto](https://github.com/CenturyAuto/century/blob/master/modules/planning/proto/pad_msg.proto), will be published by **Dreamview**.
...
- When "Pull Over" button is clicked, a pad message with `DrivingAction` of `PULL_OVER`, defined by Protobuf message `PadMessage` in [pad_msg.proto](https://github.com/CenturyAuto/century/blob/master/modules/planning/proto/pad_msg.proto), will be published by **Dreamview**.
...
- When "Resume Cruise" button is clicked, a pad message with `DrivingAction` of `RESUME_CRUISE`, defined by Protobuf message `PadMessage` in [pad_msg.proto](https://github.com/CenturyAuto/century/blob/master/modules/planning/proto/pad_msg.proto), will be published by **Dreamview**.
