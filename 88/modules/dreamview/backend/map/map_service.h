...
class MapService {
 public:
  ...
  void CollectMapElementIds(const century::common::PointENU &point,
                            double raidus, MapElementIds *ids) const;

  bool GetPathsFromRouting(const century::routing::RoutingResponse &routing,
                           std::vector<century::hdmap::Path> *paths) const;
  ...
  bool GetStartPoint(century::common::PointENU *start_point) const;
  ...
  bool CheckRoutingPointLaneType(century::hdmap::LaneInfoConstPtr lane) const;
