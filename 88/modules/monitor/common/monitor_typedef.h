...
enum MonitorErrorCode : int32_t {
  ...
  E_LOW_FREQ_LIDAR,                         ///< low lidar pointcloud freq
  E_NO_FREQ_LIDAR,                          ///< no lidar pointcloud freq
  ...
  E_LOW_FREQ_CAMERA_RIGHT_REAR,   ///< low freq camera right rear
  E_NO_FREQ_CAMERA_RIGHT_REAR,    ///< no freq camera right rear
  E_LOW_FREQ_CAMERA_REAR,         ///< low freq camera rear
  E_NO_FREQ_CAMERA_REAR,          ///< no freq camera rear
  E_LOW_FREQ_CAMERA_LEFT_FRONT,   ///< low freq camera left front
  E_NO_FREQ_CAMERA_LEFT_FRONT,    ///< no freq camera left front
  E_LOW_FREQ_CAMERA_LEFT_REAR,    ///< low freq camera left rear
  E_NO_FREQ_CAMERA_LEFT_REAR,     ///< no freq camera left rear
  E_LOW_FREQ_CAMERA_RIGHT_FRONT,  ///< low freq camera right front
  E_NO_FREQ_CAMERA_RIGHT_FRONT,   ///< no freq camera right front
  E_LOW_FREQ_CAMERA_FRONT,        ///< low freq camera front
  E_NO_FREQ_CAMERA_FRONT,         ///< no freq camera front

  E_LOW_FREQ_LIDAR_HELIOS_FRONT_LEFT,  ///< low freq lidar helios front left
  E_NO_FREQ_LIDAR_HELIOS_FRONT_LEFT,   ///< no freq lidar helios front left
  E_LOW_FREQ_LIDAR_HELIOS_REAR_RIGHT,  ///< low freq lidar helios rear right
  E_NO_FREQ_LIDAR_HELIOS_REAR_RIGHT,   ///< no freq lidar helios rear right
  E_LOW_FREQ_LIDAR_BP_FRONT_LEFT,      ///< low freq lidar bp front left
  E_NO_FREQ_LIDAR_BP_FRONT_LEFT,       ///< no freq lidar bp front left
  E_LOW_FREQ_LIDAR_BP_REAR_RIGHT,      ///< low freq lidar bp rear right
  E_NO_FREQ_LIDAR_BP_REAR_RIGHT,       ///< no freq lidar bp rear right
  E_LOW_FREQ_LIDAR_BP_REAR_LEFT,       ///< low freq lidar bp rear left
  E_NO_FREQ_LIDAR_BP_REAR_LEFT,        ///< no freq lidar bp rear left
  E_LOW_FREQ_LIDAR_BP_FRONT_RIGHT,     ///< low freq lidar bp front right
  E_NO_FREQ_LIDAR_BP_FRONT_RIGHT,      ///< no freq lidar bp front right
