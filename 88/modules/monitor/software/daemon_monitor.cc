...
// Camera topics from modules/drivers/camera/dag/camera.dag -> vehicle_config/camera_video.pb.txt
DEFINE_string(camera_right_rear_topic, "/century/sensor/camera/right_rear/image",
              "Right-rear camera image topic.");
DEFINE_string(camera_rear_topic, "/century/sensor/camera/rear/image",
              "Rear camera image topic.");
DEFINE_string(camera_left_front_topic, "/century/sensor/camera/left_front/image",
              "Left-front camera image topic.");
DEFINE_string(camera_left_rear_topic, "/century/sensor/camera/left_rear/image",
              "Left-rear camera image topic.");
DEFINE_string(camera_right_front_topic, "/century/sensor/camera/right_front/image",
              "Right-front camera image topic.");
DEFINE_string(camera_front_topic, "/century/sensor/camera/front/image",
              "Front camera image topic.");

// Lidar topics matching robosense driver dag configs
DEFINE_string(lidar_helios_front_left_topic, "/lidar/helios/front_left",
              "Helios front-left lidar topic.");
DEFINE_string(lidar_helios_rear_right_topic, "/lidar/helios/rear_right",
              "Helios rear-right lidar topic.");
DEFINE_string(lidar_bp_front_left_topic, "/lidar/bp/front_left",
              "BP front-left lidar topic.");
DEFINE_string(lidar_bp_rear_right_topic, "/lidar/bp/rear_right",
              "BP rear-right lidar topic.");
DEFINE_string(lidar_bp_rear_left_topic, "/lidar/bp/rear_left",
              "BP rear-left lidar topic.");
DEFINE_string(lidar_bp_front_right_topic, "/lidar/bp/front_right",
              "BP front-right lidar topic.");
DEFINE_string(lidar_rsm1_front_topic, "/lidar/m1/front",
              "RSM1 front lidar topic.");
DEFINE_string(lidar_rsm1_rear_topic, "/lidar/m1/rear",
              "RSM1 rear lidar topic.");
...
void DaemonMonitor::InitializeChannelWarnings() {
  const std::vector<std::pair<std::string, MonitorErrorCode>> warning_channels =
      {{FLAGS_localization_topic, E_LOW_FREQ_LOCALIZATION},
       ...
       {FLAGS_camera_right_rear_topic, E_LOW_FREQ_CAMERA_RIGHT_REAR},
       {FLAGS_camera_rear_topic, E_LOW_FREQ_CAMERA_REAR},
       {FLAGS_camera_left_front_topic, E_LOW_FREQ_CAMERA_LEFT_FRONT},
       {FLAGS_camera_left_rear_topic, E_LOW_FREQ_CAMERA_LEFT_REAR},
       {FLAGS_camera_right_front_topic, E_LOW_FREQ_CAMERA_RIGHT_FRONT},
       {FLAGS_camera_front_topic, E_LOW_FREQ_CAMERA_FRONT},
       {FLAGS_lidar_helios_front_left_topic, E_LOW_FREQ_LIDAR_HELIOS_FRONT_LEFT},
       {FLAGS_lidar_helios_rear_right_topic, E_LOW_FREQ_LIDAR_HELIOS_REAR_RIGHT},
       {FLAGS_lidar_bp_front_left_topic, E_LOW_FREQ_LIDAR_BP_FRONT_LEFT},
       {FLAGS_lidar_bp_rear_right_topic, E_LOW_FREQ_LIDAR_BP_REAR_RIGHT},
       {FLAGS_lidar_bp_rear_left_topic, E_LOW_FREQ_LIDAR_BP_REAR_LEFT},
       {FLAGS_lidar_bp_front_right_topic, E_LOW_FREQ_LIDAR_BP_FRONT_RIGHT}};
...
void DaemonMonitor::InitializeChannelErrors() {
  const std::vector<std::pair<std::string, MonitorErrorCode>> error_channels = {
      ...
      {FLAGS_camera_right_rear_topic, E_NO_FREQ_CAMERA_RIGHT_REAR},
      {FLAGS_camera_rear_topic, E_NO_FREQ_CAMERA_REAR},
      {FLAGS_camera_left_front_topic, E_NO_FREQ_CAMERA_LEFT_FRONT},
      {FLAGS_camera_left_rear_topic, E_NO_FREQ_CAMERA_LEFT_REAR},
      {FLAGS_camera_right_front_topic, E_NO_FREQ_CAMERA_RIGHT_FRONT},
      {FLAGS_camera_front_topic, E_NO_FREQ_CAMERA_FRONT},
      {FLAGS_lidar_helios_front_left_topic, E_NO_FREQ_LIDAR_HELIOS_FRONT_LEFT},
      {FLAGS_lidar_helios_rear_right_topic, E_NO_FREQ_LIDAR_HELIOS_REAR_RIGHT},
      {FLAGS_lidar_bp_front_left_topic, E_NO_FREQ_LIDAR_BP_FRONT_LEFT},
      {FLAGS_lidar_bp_rear_right_topic, E_NO_FREQ_LIDAR_BP_REAR_RIGHT},
      {FLAGS_lidar_bp_rear_left_topic, E_NO_FREQ_LIDAR_BP_REAR_LEFT},
      {FLAGS_lidar_bp_front_right_topic, E_NO_FREQ_LIDAR_BP_FRONT_RIGHT}};
...
DaemonMonitor::DaemonMonitor()
...
#ifdef __aarch64__
  node_name += IsSlaveOrin() ? "slave" : "master";
#else
  node_name += "x86";
#endif
  ...
  if (DOMAIN_TYPE == common::DomainType::AARCH64) {
    channel_name = IsSlaveOrin() ? "/century/monitor/monitor_data_slave"
