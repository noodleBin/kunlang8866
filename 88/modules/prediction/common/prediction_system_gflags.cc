...
DEFINE_string(prediction_conf_file,
              "/century/modules/prediction/conf/prediction_conf.pb.txt",
              "Default conf file for prediction");
DEFINE_string(prediction_adapter_config_filename,
              "/century/modules/prediction/conf/adapter.conf",
              "Default conf file for prediction");
DEFINE_string(prediction_data_dir,
              "/century/modules/prediction/data/prediction/",
...
DEFINE_string(container_topic_name, "/century/prediction/container",
              "Container topic name");
DEFINE_string(adccontainer_topic_name, "/century/prediction/adccontainer",
              "ADC Container topic name");
DEFINE_string(evaluator_topic_name, "/century/prediction/evaluator",
...
DEFINE_string(perception_obstacles_topic_name,
              "/century/prediction/perception_obstacles",
              "Internal topic of perception obstacles");

// VectorNet
DEFINE_string(prediction_target_file, "/century/data/train/test.pb.txt",
              "VectorNet target pb file name");
DEFINE_string(world_coordinate_file, "/century/data/world_coord.bin",
              "VectorNet world coordinate file name");
DEFINE_string(prediction_target_dir, "/century/data/train/",
