...
DEFINE_string(torch_vehicle_junction_mlp_file,
              "/century/modules/prediction/data/junction_mlp_vehicle_model.pt",
              "Vehicle junction MLP model file");
DEFINE_string(torch_vehicle_junction_map_file,
              "/century/modules/prediction/data/junction_map_vehicle_model.pt",
              "Vehicle junction map model file");
DEFINE_string(torch_vehicle_semantic_lstm_file,
              "/century/modules/prediction/data/semantic_lstm_vehicle_model.pt",
              "Vehicle semantic lstm model file, default for gpu");
DEFINE_string(
    torch_vehicle_semantic_lstm_cpu_file,
    "/century/modules/prediction/data/semantic_lstm_vehicle_cpu_model.pt",
    "Vehicle semantic lstm cpu model file");
DEFINE_string(torch_vehicle_cruise_go_file,
              "/century/modules/prediction/data/cruise_go_vehicle_model.pt",
              "Vehicle cruise go model file");
DEFINE_string(torch_vehicle_cruise_cutin_file,
              "/century/modules/prediction/data/cruise_cutin_vehicle_model.pt",
              "Vehicle cruise cutin model file");
DEFINE_string(torch_vehicle_lane_scanning_file,
              "/century/modules/prediction/data/lane_scanning_vehicle_model.pt",
              "Vehicle lane scanning model file");
DEFINE_string(torch_vehicle_vectornet_file,
              "/century/modules/prediction/data/vectornet_vehicle_model.pt",
              "Vehicle vectornet model file");
DEFINE_string(torch_vehicle_vectornet_cpu_file,
              "/century/modules/prediction/data/vectornet_vehicle_cpu_model.pt",
              "Vehicle vectornet cpu model file");
DEFINE_string(trt_vehicle_vectornet_engine_file,
              "/century/vectornet_vehicle.engine",
              "Vehicle vectornet TRT engine file");
DEFINE_string(trt_vehicle_vectornet_arm_engine_file,
              "/century/modules/prediction/data/vectornet_vehicle_arm.plan",
              "Vehicle vectornet TRT plan file for ARM/Orin");
DEFINE_string(trt_vehicle_vectornet_x86_engine_file,
              "/century/modules/prediction/data/vectornet_vehicle_x86_x50.plan",
              "Vehicle vectornet TRT plan file for x86/x50");
...
DEFINE_string(
    ...
    "/century/modules/prediction/data/semantic_lstm_pedestrian_model.pt",
    "Pedestrian semantic lstm model file, default for gpu");
DEFINE_string(
    torch_pedestrian_semantic_lstm_cpu_file,
    "/century/modules/prediction/data/semantic_lstm_pedestrian_cpu_model.pt",
...
DEFINE_int32(max_num_obstacles, 1024,
