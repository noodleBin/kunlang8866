...
class PredictionMap {
 public:
   ...
   */
  static std::shared_ptr<const century::hdmap::LaneInfo>
   ...
   */
  static std::vector<std::shared_ptr<const century::hdmap::JunctionInfo>>
   ...
   * @return A list of junctions
   */
  static std::vector<std::shared_ptr<const century::hdmap::PNCJunctionInfo>>
