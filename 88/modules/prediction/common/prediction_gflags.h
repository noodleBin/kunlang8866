...
DECLARE_string(trt_vehicle_vectornet_engine_file);
DECLARE_string(trt_vehicle_vectornet_arm_engine_file);
DECLARE_string(trt_vehicle_vectornet_x86_engine_file);
