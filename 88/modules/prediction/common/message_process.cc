...
void MessageProcess::ContainerProcess(
  ...
  // Insert ADC after perception obstacles are loaded. In replay mode Insert()
  // may clear the obstacle cache when the perception timestamp jumps, so ego
  // must be re-inserted afterwards.
