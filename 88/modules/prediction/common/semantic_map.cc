...
void SemanticMap::DrawRoads(const common::PointENU& center_point,
  ...
  century::hdmap::HDMapUtil::BaseMap().GetRoads(center_point, 141.4, &roads);
...
void SemanticMap::DrawJunctions(const common::PointENU& center_point,
  ...
  century::hdmap::HDMapUtil::BaseMap().GetJunctions(center_point, 141.4,
                                                   &junctions);
...
void SemanticMap::DrawCrosswalks(const common::PointENU& center_point,
  ...
  century::hdmap::HDMapUtil::BaseMap().GetCrosswalks(center_point, 141.4,
                                                    &crosswalks);
...
void SemanticMap::DrawLanes(const common::PointENU& center_point,
  ...
  century::hdmap::HDMapUtil::BaseMap().GetLanes(center_point, 141.4, &lanes);
