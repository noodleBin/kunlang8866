...
using century::hdmap::LaneInfo;
using century::prediction::math_util::EvaluateCubicPolynomial;
using century::prediction::math_util::EvaluateQuarticPolynomial;
...
std::pair<double, double> MoveSequencePredictor::ComputeLonEndState(
  ...
  double v_end = century::prediction::predictor_util::AdjustSpeedByCurvature(
      init_s[1], max_kappa);
