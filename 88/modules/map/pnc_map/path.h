...
class PathApproximation {
 public:
  ...
  void GetProjectionSegmentsMinprj(int *first_segment_idx, int i,
                int last_segment_idx, const double min_projection) const;
  bool GetProjectionSegments(const common::math::Vec2d& point,
...
class Path {
 public:
  ...
  bool GetProjection(const common::math::Vec2d& point, double* accumulate_s,
                     double* lateral, double* distance) const;
  bool GetProjectionUseOneProjection(const common::math::Vec2d& point,
                                     const double adc_s, double* accumulate_s,
                                     double* lateral) const;
  bool GetProjectionUseOneProjection(const common::math::Vec2d& point,
                                     const double adc_s, double* accumulate_s,
                                     double* lateral,
  ...
  /*
   * @brief check whether the bounding box is on path
   * @param box   vehicle bounding box
   * @return true if the vehicle bounding box is on path
   */
  bool IsOnPath(const common::math::Box2d& box) const;

  /*
   * @brief check whether the point is on path
   * @param point   the point
   * @return true if the point is on path
   */
  bool IsOnPath(const common::math::Vec2d& point) const;
  bool OverlapWith(const common::math::Box2d& box, double width) const;
  bool OverlapWith(const common::math::Box2d& box,
