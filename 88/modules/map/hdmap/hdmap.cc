...
ParkingLotInfoConstPtr HDMap::GetParkingLotById(const Id& id) const {
  return impl_.GetParkingLotById(id);
}
...
ObstacleInfoConstPtr HDMap::GetObstacleAreaById(const Id& id) const {
  return impl_.GetObstacleAreaById(id);
}

ElectricFenceInfoConstPtr HDMap::GetElectricFenceById(const Id& id) const {
  return impl_.GetElectricFenceById(id);
}

int HDMap::GetLanes(const century::common::PointENU& point, double distance,
                    std::vector<LaneInfoConstPtr>* lanes) const {
  return impl_.GetLanes(point, distance, lanes);
}

int HDMap::GetJunctions(const century::common::PointENU& point, double distance,
                        std::vector<JunctionInfoConstPtr>* junctions) const {
  return impl_.GetJunctions(point, distance, junctions);
}

int HDMap::GetElectricFences(
    const century::common::PointENU& point, double distance,
    std::vector<ElectricFenceInfoConstPtr>* electric_fences) const {
  return impl_.GetElectricFences(point, distance, electric_fences);
}

int HDMap::GetSignals(const century::common::PointENU& point, double distance,
                      std::vector<SignalInfoConstPtr>* signals) const {
  return impl_.GetSignals(point, distance, signals);
}

int HDMap::GetCrosswalks(const century::common::PointENU& point,
                         double distance,
                         std::vector<CrosswalkInfoConstPtr>* crosswalks) const {
  return impl_.GetCrosswalks(point, distance, crosswalks);
}

int HDMap::GetStopSigns(const century::common::PointENU& point, double distance,
...
int HDMap::GetRoads(const century::common::PointENU& point, double distance,
...
int HDMap::GetParkingLots(
    const century::common::PointENU& point, double distance,
    std::vector<ParkingLotInfoConstPtr>* parking_lots) const {
  return impl_.GetParkingLots(point, distance, parking_lots);
}
...
int HDMap::GetNearestLaneWithHeading(const century::common::PointENU& point,
...
int HDMap::GetLanesWithHeading(const century::common::PointENU& point,
                               const double distance,
                               const double central_heading,
                               const double max_heading_difference,
                               std::vector<LaneInfoConstPtr>* lanes) const {
...
int HDMap::GetRoadBoundaries(
    const century::common::PointENU& point, double radius,
...
int HDMap::GetRoadBoundaries(
    const century::common::PointENU& point, double radius,
    const std::vector<Id>& ref_ids, std::vector<RoadRoiPtr>* road_boundaries,
    std::vector<JunctionInfoConstPtr>* junctions) const {
  return impl_.GetRoadBoundaries(point, radius, ref_ids, road_boundaries,
                                 junctions);
}
...
int HDMap::GetRoadBoundaries(
    ...
    std::vector<JunctionInfoConstPtr>* junctions) const {
  return impl_.GetRoadBoundaries(road_ids, road_boundaries, junctions);
}

int HDMap::GetRoi(const century::common::PointENU& point, double radius,
...
int HDMap::GetLocalMap(const century::common::PointENU& point,
                       const std::pair<double, double>& range,
                       Map* local_map) const {
  return impl_.GetLocalMap(point, range, local_map);
}

int HDMap::GetForwardNearestRSUs(const century::common::PointENU& point,
...
int HDMap::GetLanesWithNearPos(const century::common::PointENU& point,
                               const double distance,
                               std::vector<LaneInfoConstPtr>* lanes) const {
  return impl_.GetLanesWithNearPos(point, distance, lanes);
}

int HDMap::GetObstacleAreas(
    const century::common::PointENU& point, double distance,
    std::vector<ObstacleInfoConstPtr>* obstacles) const {
  return impl_.GetObstacleAreas(point, distance, obstacles);
}

bool HDMap::IsInRodArea(const century::common::PointENU& point) const {
  return impl_.IsInRodArea(point);
}
