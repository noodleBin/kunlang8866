...
/**
 * @namespace century::relative_map
 * @brief century::relative_map
 */
namespace century {
...
class NavigationLane {
 ...
 private:
  ...
  void GeneratePathOnPerception(
      const century::perception::LaneMarkers& lane_marker);
  void CreateNavigationPathList();
  void CalculatePathWidth();
  void ProcessNavigationPaths(
  ...
  void EnuToFlu(const double enu_x, const double enu_y, const double enu_theta,
                double* flu_x, double* flu_y, double* flu_theta);
  void GenNaviPathLoop(const int start, const int end, const double ref_s_base,
                       const double max_length,
                       const common::Path& navigation_path, common::Path* path);

 private:
  // the configuration information required by the `NavigationLane`
  NavigationLaneConfig config_;

  // received from topic: /century/perception_obstacles
  perception::PerceptionObstacles perception_obstacles_;

  // received from topic: /century/navigation
