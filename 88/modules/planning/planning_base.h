...
class PlanningBase {
 public:
  ...
  virtual century::common::Status Init(const PlanningConfig& config);
   ...
   */
  virtual century::common::Status Plan(
 ...
 protected:
  ...
  size_t seq_num_ = 0;
  size_t seq_num_teb_ = 0;

  PlanningConfig config_;
  TrafficRuleConfigs traffic_rule_configs_;
  std::unique_ptr<Frame> frame_;
  std::unique_ptr<Frame> frame_teb_;
 ...
 public:
  ...
  bool calculation_result_ = false;
  bool last_use_teb_trajectory_ = false;
};
