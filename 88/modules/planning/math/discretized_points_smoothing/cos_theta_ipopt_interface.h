...
class CosThetaIpoptInterface : public Ipopt::TNLP {
 public:
  ...
  //***************    end   ADOL-C part ***********************************
 private:
  void eval_h_v1(const int n, const double* x, bool new_x, double obj_factor,
                 const int m, const double* lambda, bool new_lambda,
                 int nele_hess, int* iRow, int* jCol, double* values);
  void eval_h_v2(const int n, const double* x, bool new_x, double obj_factor,
                 const int m, const double* lambda, bool new_lambda,
                 int nele_hess, int* iRow, int* jCol, double* values);
  void eval_h_v3(const int n, const double* x, bool new_x, double obj_factor,
                 const int m, const double* lambda, bool new_lambda,
                 int nele_hess, int* iRow, int* jCol, double* values);
