...
class GridSearch {
 public:
  ...
  void SetRotateAngle(const double rotate_angle) {
    rotate_angle_ = rotate_angle;
  }

  void SetOriginPoint(const common::math::Vec2d translate_origin) {
