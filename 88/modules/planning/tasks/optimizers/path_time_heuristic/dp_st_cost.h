...
class DpStCost {
 public:
  ...
  double GetObstacleCost(const bool is_need_slow_breaking,
 ...
 private:
  ...
  double GetFollowDistance(const century::planning::STBoundary& boundary) const;
  double GetFollowDistanceForHighSpeed(
      const century::planning::STBoundary& boundary) const;
  double GetObstacleBoundaryCost(const StGraphPoint& st_graph_point,
                                 const double& s, const double& t,
                                 const double& cost);
  bool CheckIsSlowBreakingObstacle(const Obstacle& obstacle);
