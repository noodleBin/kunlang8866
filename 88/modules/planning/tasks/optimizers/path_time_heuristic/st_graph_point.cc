...
void StGraphPoint::AddPrePointR(uint32_t pre_point_r) {
  pre_points_r_.emplace_back(pre_point_r);
}

const std::vector<uint32_t>& StGraphPoint::GetPrePointsR() const {
  return pre_points_r_;
}
