...
class LaneChangeDecider : public Decider {
 public:
  ...
  static bool IsClearToChangeLane(ReferenceLineInfo* reference_line_info,
                                  const bool in_expressway_junction = false);
 ...
 private:
  ...
  common::Status MakeLaneChangeDecider(
      Frame* frame, ReferenceLineInfo* const current_reference_line_info);

  common::Status UpdateStatusBaseOnReferencePath(
      std::list<ReferenceLineInfo>* reference_line_info,
      ReferenceLineInfo* const current_reference_line_info);

  common::Status UpdateStatusBaseOnChangeLanePath(
      std::list<ReferenceLineInfo>* reference_line_info,
      ReferenceLineInfo* const current_reference_line_info);
  ...
  bool AdcInChangeLane(std::list<ReferenceLineInfo>* reference_line_info) const;
