...
class LaneOvertakeConditionTest : public ::testing::Test {
 public:
  virtual void SetUp() {
...
TEST_F(LaneOvertakeConditionTest, Default2Default) {
  FsmCondition lane_overtake_condition(config_, injector_);
  EXPECT_EQ(false, lane_overtake_condition.Default2Default(
