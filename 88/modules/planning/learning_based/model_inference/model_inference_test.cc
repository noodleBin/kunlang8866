...
class ModelInferenceTest : public ::testing::Test {
 public:
  ...
  virtual void SetUp() {
    FLAGS_map_dir = "/century/modules/map/data/sunnyvale_with_two_offices";
...
TEST_F(ModelInferenceTest, trajectory_imitation_libtorch_inference) {
  FLAGS_test_model_inference_task_config_file =
      "/century/modules/planning/testdata/model_inference_test/"
  ...
  ACHECK(century::cyber::common::GetProtoFromFile(FLAGS_test_data_frame_file,
                                                 &test_data_frame))
