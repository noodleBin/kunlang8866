...
class NaviObstacleDecider : public NaviTask {
 ...
 private:
   ...
   */
  const century::common::VehicleParam &VehicleParam();
...
inline const century::common::VehicleParam &NaviObstacleDecider::VehicleParam() {
  const auto &vehicle_param = century::common::VehicleConfigHelper::Instance()
                                  ->GetConfig()
                                  .vehicle_param();
