...
class SpiralReferenceLineSmoother : public ReferenceLineSmoother {
 public:
  ...
  int SmoothStandAlone(const std::vector<Eigen::Vector2d>& point2d,
 ...
 private:
  ...
  bool SmoothWithoutAnchorPoints(const ReferenceLine& raw_reference_line,
                                 std::vector<double>* ptr_theta,
                                 std::vector<double>* ptr_kappa,
                                 std::vector<double>* ptr_dkappa,
  ...
  bool SmoothWithAnchorPoints(std::vector<double>* ptr_theta,
                              std::vector<double>* ptr_kappa,
                              std::vector<double>* ptr_dkappa,
                              std::vector<double>* ptr_s,
                              std::vector<double>* ptr_x,
