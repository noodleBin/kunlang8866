...
class AudioInfo {
 public:
  ...
  void Insert(
      const century::drivers::microphone::config::AudioData&);
 ...
 private:
  void InsertChannelData(
      ...
      const century::drivers::microphone::config::ChannelData& channel_data,
      const century::drivers::microphone::config::MicrophoneConfig&
          microphone_config);
