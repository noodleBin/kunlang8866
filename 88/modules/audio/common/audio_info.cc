...
using century::drivers::microphone::config::AudioData;
using century::drivers::microphone::config::ChannelData;
using century::drivers::microphone::config::ChannelType;
using century::drivers::microphone::config::MicrophoneConfig;
