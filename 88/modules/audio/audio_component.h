...
class AudioComponent
    : public cyber::Component<century::drivers::microphone::config::AudioData> {
 public:
  ~AudioComponent();
  ...
  bool Proc(
      const std::shared_ptr<century::drivers::microphone::config::AudioData>&)
      override;
