...
TEST(loadTest, test) {
  ACHECK(!century::perception::inference::load_binary_data("unknown.txt"));
}
...
TEST(UtilTest, test) {
  ...
  //   std::shared_ptr<century::perception::base::Blob<float>> blob;
  //   blob.reset(new century::perception::base::Blob<float>(1, h_small, w_small,
  //                                                        rgb_channel));
  //   std::shared_ptr<century::perception::base::SyncedMemory> src_gpu;
  //   src_gpu.reset(new century::perception::base::SyncedMemory(
  ...
  //     ACHECK(century::perception::inference::resize(
