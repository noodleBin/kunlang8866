...
DEFINE_string(obs_sensor_intrinsic_path,
              "/century/modules/perception/data/params",
...
DEFINE_string(obs_sensor_meta_path,
              "/century/modules/perception/production"
...
DEFINE_string(pfe_torch_file,
              "/century/modules/perception/production/data/perception/lidar/"
...
DEFINE_string(onnx_obstacle_detector_model,
              "/century/modules/perception/camera"
...
DEFINE_string(onnx_test_input_path,
              "/century/modules/perception/inference"
...
DEFINE_string(pointpillars_engine_path,
              "/century/modules/perception/production/data/perception/lidar/"
              "models/detection/point_pillars/",
              "The path of pillars feature extractor torch file.");

DEFINE_string(centerpoint_engine_path,
              "/century/modules/perception/production/data/perception/lidar/models/"
              "detection/center_point/",
              "The path of centerpoint feature extractor torch file.");
...
DEFINE_int32(port_type, 0, "default qing dao port");
