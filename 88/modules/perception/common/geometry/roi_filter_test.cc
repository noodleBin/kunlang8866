...
using century::perception::base::HdmapStruct;
using HdmapStructConstPtr =
    std::shared_ptr<const century::perception::base::HdmapStruct>;
using HdmapStructPtr = std::shared_ptr<century::perception::base::HdmapStruct>;
using century::perception::base::Object;
using century::perception::base::PointD;
using ObjectConstPtr = std::shared_ptr<const century::perception::base::Object>;
using ObjectPtr = std::shared_ptr<century::perception::base::Object>;
