...
class CCRFOneShotTypeFusion : public BaseOneShotTypeFusion {
 ...
 protected:
  century::common::EigenMap<std::string, Matrixd> smooth_matrices_;
...
class CCRFSequenceTypeFusion : public BaseSequenceTypeFusion {
 ...
 protected:
  ...
  century::common::EigenVector<Vectord> fused_oneshot_probs_;
  century::common::EigenVector<Vectord> fused_sequence_probs_;
  century::common::EigenVector<Vectori> state_back_trace_;
