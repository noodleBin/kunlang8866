...
using century::perception::base::ObjectType;
...
bool MlfTypeFilter::Init(const MlfFilterInitOptions& options) {
    ...
    one_shot_fuser_ = new CCRFSingleShotTypeFusion();
    //BaseSingleShotTypeFusionRegisterer::GetInstanceByName(
    ...
    sequence_fuser_ = new CCRFMultiShotTypeFusion();
    //BaseMultiShotTypeFusionRegisterer::GetInstanceByName(
