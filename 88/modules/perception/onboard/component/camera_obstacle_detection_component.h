...
typedef std::shared_ptr<century::perception::Motion_Service>
...
class CameraObstacleDetectionComponent : public century::cyber::Component<> {
 public:
 ...
 public:
  ...
  bool Init() override;
  void OnReceiveImage(
      const std::shared_ptr<century::drivers::Image>& in_message,
 ...
 private:
  ...
  std::shared_ptr<
      century::cyber::Writer<century::perception::PerceptionObstacles>>
      writer_;

  std::shared_ptr<century::cyber::Writer<SensorFrameMessage>>
      sensorframe_writer_;

  std::shared_ptr<century::cyber::Writer<CameraPerceptionVizMessage>>
      camera_viz_writer_;

  std::shared_ptr<
      century::cyber::Writer<century::perception::camera::CameraDebug>>
