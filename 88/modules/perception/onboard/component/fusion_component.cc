...
bool FusionComponent::InternalProc(
  ...
  century::common::ErrorCode error_code = century::common::ErrorCode::OK;
  ...
  const double cur_time = ::century::cyber::Clock::NowInSeconds();
