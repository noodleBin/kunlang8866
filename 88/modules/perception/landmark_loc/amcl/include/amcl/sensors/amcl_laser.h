...
class AMCLLaserData : public AMCLSensorData
{
  public:
    ...
    explicit AMCLLaserData(int count) {
      range_count = count;
      ranges = new double[count][2]; 
  ...
  public: double range_max = 80.0;
  public: double (*ranges)[2];
  public: int* labels;
  public: double to_odom_distance = 5.0;
};
...
class AMCLLaser : public AMCLSensor
{
  ...
  explicit AMCLLaser(size_t max_beams, std::array<map_t*, MapLayerSize> map_layers);
