...
class LidarLibSceneManagerTest : public testing::Test {
 protected:
  void SetUp() {
    ...
    putenv(module_path);
    FLAGS_work_root =
        "/century/modules/perception/testdata/lidar/lib/scene_manager";
...
TEST_F(LidarLibSceneManagerTest, lidar_lib_scene_manager_ground_service_test) {
  ...
  LoadPlanes(
      "/century/modules/perception/testdata/lidar/lib/"
...
void MockData(LidarFrame* frame) {
  std::string pcd =
      "/century/modules/perception/testdata/lidar/lib/scene_manager/data/"
