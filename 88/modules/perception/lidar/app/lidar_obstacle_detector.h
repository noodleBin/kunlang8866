...
class LidarObstacleDetector : public BaseLidarObstacleDetection{
 public:
  LidarObstacleDetector() = default;
  virtual ~LidarObstacleDetector() = default;
  ...
  std::string Name() const override { return "LidarObstacleDetector"; }
