...
double GetAngleFromQuaternion(const century::common::Quaternion quaternion);

void FillPerceptionPolygon(
    century::perception::PerceptionObstacle* const perception_obstacle,
...
century::common::Point3D SLtoXY(const double x, const double y,
                               const double theta);

century::common::Point3D SLtoXY(const century::common::Point3D& point,
                               const double theta);

double Distance(const century::common::Point3D& point1,
                const century::common::Point3D& point2);

double Speed(const century::common::Point3D& point);

double Speed(const double vx, const double vy);

double GetNearestLaneHeading(const century::common::PointENU& point_enu);

double GetNearestLaneHeading(const century::common::Point3D& point);

double GetNearestLaneHeading(const double x, const double y, const double z);

double GetLateralDistanceToNearestLane(const century::common::Point3D& point);
