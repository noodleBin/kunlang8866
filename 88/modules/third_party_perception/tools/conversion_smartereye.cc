...
/**
 * @namespace century::third_party_perception::conversion_smartereye
...
using Point = century::common::Point3D;

century::perception::PerceptionObstacles SmartereyeToPerceptionObstacles(
    const century::drivers::SmartereyeObstacles& smartereye_obstacles,
    const century::drivers::SmartereyeLanemark& smartereye_lanemark,
    const century::localization::LocalizationEstimate& localization,
    const century::canbus::Chassis& chassis) {
