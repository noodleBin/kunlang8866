...
/**
 * @namespace century::third_party_perception::conversion_radar
...
RadarObstacles ContiToRadarObstacles(
    const century::drivers::ContiRadar& conti_radar,
...
RadarObstacles DelphiToRadarObstacles(
  ...
  std::vector<century::drivers::Esr_trackmotionpower_540::Motionpower>
      motionpowers(64);
  ...
  for (int index = 0; index < delphi_esr.esr_track01_500_size() &&
    ...
    if (data_500.can_tx_track_status() ==
        century::drivers::Esr_track01_500::CAN_TX_TRACK_STATUS_NO_TARGET) {
      continue;
    }
