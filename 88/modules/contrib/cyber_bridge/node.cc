...
using century::cyber::message::PyMessageWrap;

Node::Node() : node(century::cyber::CreateNode("bridge")) {}
...
void Node::add_writer(const std::string& channel, const std::string& type,
  ...
  century::cyber::message::ProtobufFactory::Instance()->GetDescriptorString(
      type, &writer.desc);
  ...
  century::cyber::proto::RoleAttributes role;
