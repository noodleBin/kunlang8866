...
You can download the elo (aka Ego Localization) module here [elo-1.5.zip](https://github.com/CenturyAuto/century/releases/download/v1.5.0/elo-1.5.zip)
...
* Test data path:
  ...
  [testdata.zip](http://data.century.auto)
...
* To run the localization demo in testdata1:
  ...
  ```Shell
  ./localization_test ../config/century_release.config ../data/testdata1/test_list.txt ../data/testdata1/image/
  ```
