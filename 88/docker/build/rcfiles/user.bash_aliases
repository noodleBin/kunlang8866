...
export PATH="$PATH:/century/scripts"
...
#if [ -e "/century/scripts/century_base.sh" ]; then
#    . /century/scripts/century_base.sh
#fi
if [ -e "/century/cyber/setup.bash" ]; then
    . /century/cyber/setup.bash
fi

if [ -e "/century/scripts/century_auto_complete.bash" ]; then
    . /century/scripts/century_auto_complete.bash
fi
