...
using century::cyber::proto::ComponentConfig;
using century::cyber::proto::TimerComponentConfig;
...
TEST(CommonComponent, init) {
  ret_proc = true;
  ret_init = true;
  century::cyber::proto::ComponentConfig compcfg;
  ...
  century::cyber::proto::ReaderOption *read_opt = compcfg.add_readers();
  ...
  century::cyber::proto::ReaderOption *read_opt2 = compcfg.add_readers();
  ...
  century::cyber::proto::ReaderOption *read_opt3 = compcfg.add_readers();
  read_opt3->set_channel("/driver/channel2");
  compcfg.set_name("perception4");
  century::cyber::proto::ReaderOption *read_opt4 = compcfg.add_readers();
