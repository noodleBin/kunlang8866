...
TEST(ProtobufFactory, register_and_generate) {
  ...
  century::cyber::proto::ProtoDesc proto_desc;
  proto::UnitTest ut;
  ...
  get_desc_str.clear();
  factory->GetDescriptorString("century.cyber.proto.UnitTest", &get_desc_str);
  EXPECT_EQ(get_desc_str, proto_desc_str);
  ...
  message = factory->GenerateMessageByType("century.cyber.proto.UnitTest");
  ...
  desc_ptr = factory->FindMessageTypeByName("century.cyber.proto.UnitTest");
