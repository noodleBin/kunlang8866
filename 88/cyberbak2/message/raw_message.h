...
struct RawMessage {
  ...
  class Descriptor {
   public:
    std::string full_name() const { return "century.cyber.message.RawMessage"; }
    std::string name() const { return "century.cyber.message.RawMessage"; }
  };
  ...
  static std::string TypeName() { return "century.cyber.message.RawMessage"; }
