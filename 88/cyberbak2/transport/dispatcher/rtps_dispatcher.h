...
class RtpsDispatcher : public Dispatcher {
 public:
  ...
  using RawMessageListener =
      std::function<void(const std::shared_ptr<std::string>&,
                         const MessageInfo&)>;
  ...
  void AddRawListener(const RoleAttributes& self_attr,
                      const RawMessageListener& listener);
...
inline void RtpsDispatcher::AddRawListener(
    const RoleAttributes& self_attr, const RawMessageListener& listener) {
