...
const char LIBRARY_1[] =
    "/century/bazel-bin/cyber/class_loader/test/libplugin1.so";
const char LIBRARY_2[] =
    "/century/bazel-bin/cyber/class_loader/test/libplugin2.so";
using century::cyber::class_loader::ClassLoader;
using century::cyber::class_loader::ClassLoaderManager;
using century::cyber::class_loader::utility::IsLibraryLoadedByAnybody;
...
TEST(ClassLoaderTest, util_test) {
  ClassLoader loader1(LIBRARY_1);
  century::cyber::class_loader::utility::LoadLibrary("1", &loader1);
  century::cyber::class_loader::utility::UnloadLibrary("1", nullptr);
  century::cyber::class_loader::utility::IsLibraryLoaded(LIBRARY_1, &loader1);
  century::cyber::class_loader::utility::IsLibraryLoaded(LIBRARY_2, &loader1);
}
