...
Century 7.0 incorporates 3 brand new deep learning models to enhance the capabilities for Century Perception and Prediction modules. Century Studio is introduced in this version, combining with Data Pipeline, to provide a one-stop online development platform to better serve Century developers. Century 7.0 also publishes the PnC reinforcement learning model training and simulation evaluation service based on previous simulation service.
...
**[Note]** All models and methodologies included in Century 7.0 are for research purposes only. Productized and commercial uses of these models are **NOT** encouraged, and it is at your own risk. Please be cautious to try Century 7.0 with enough safety protection mechanism. Your feedback is highly appreciated for us to continuously improve the models.

# Release 6.0

Century 6.0 incorporates new deep learning models to enhance the capabilities for certain Century modules. This version works seamlessly with new additions of data pipeline services to better serve Century developers. Century 6.0 is also the first version to integrate certain features as a demonstration of our continuous exploration and experimentation efforts towards driverless technology.
...
**[Note]** All models and methodologies included in Century 6.0 are for research purposes only. Productized and commercial uses of these models are **NOT** encouraged, and it is at your own risk. Please be cautious to try Century 6.0 with enough safety protection mechanism. Your feedback is highly appreciated for us to continuously improve the models.

# Release 5.5

Century 5.5 enhances the complex urban road autonomous driving capabilities of previous Century releases, by introducing curb-to-curb driving support. With this new addition, Century is now a leap closer to fully autonomous urban road driving. The car has complete 360-degree visibility, along with upgraded perception deep learning model a brand new prediction model to handle the changing conditions of complex road and junction scenarios, making the car more secure and aware. New Planning scenarios have been introduced to support curb-side functionality.
...
Century 3.5 is capable of navigating through complex driving scenarios such as residential and downtown areas. With 360-degree visibility and upgraded perception algorithms to handle the changing conditions of urban roads, the car is more secure and aware.
...
* Upgraded Sensor Suite
    ...
    * Century Expansion Unit (AXU)
    * Additional IPC
* Brand new Runtime Framework - **Century CyberRT** which is specifically targeted towards autonomous driving
* New Perception algorithms
...
Century 3.0 enables L4 product level solution that allows vehicles to drive in a closed venue setting at a low speed. Automakers can now leverage this one stop solution for autonomous driving without having to customize on their own.
...
# Release 1.0
Initial release of Century implements autonomous GPS waypoint following.
