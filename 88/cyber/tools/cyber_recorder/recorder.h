...
using century::cyber::base::Connection;
using century::cyber::message::RawMessage;
using century::cyber::proto::ChangeMsg;
using century::cyber::proto::RoleAttributes;
using century::cyber::proto::RoleType;
using century::cyber::service_discovery::ChannelManager;
