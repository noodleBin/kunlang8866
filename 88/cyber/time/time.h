...
class Time {
 public:
  ...
  /**
   * @brief convert time to millisecond (ms).
   *
   * @return return a unit64_t value unit is ms.
   */
  ...
  /**
   * @brief convert time to a string. "%F %T"
   *
   * @return return a string.
   */
  std::string ToString() const;
  /**
   * @brief convert time to a string. "%Y%m%d%H%M%S"
   *
   * @return return a string.
   */
  ...
  /**
   * @brief convert time to a vector. "%Y%m%d%H%M%S"
   *
