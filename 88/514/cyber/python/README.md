...
to write your own Python3 programs. Please make sure you have built Century
successfully.
...
**Note**: Like C++, Python code is also managed by Bazel starting from Century 6.0.
Please refer to [How to Build and Run Python Apps in Century](../../docs/howto/how_to_build_and_run_python_app.md) for more on that.
