...
using GlobalData = ::century::cyber::common::GlobalData;

using AtomicRWLock = ::century::cyber::base::AtomicRWLock;
using AtomicWriteLockGuard =
    ::century::cyber::base::WriteLockGuard<AtomicRWLock>;
using AtomicReadLockGuard = ::century::cyber::base::ReadLockGuard<AtomicRWLock>;
  ...
  switch (clock->mode_) {
    ...
    default:
      AFATAL << "Unsupported clock mode: "
             << century::cyber::common::ToInt(clock->mode_);
  }
  return Time::Now();
}
