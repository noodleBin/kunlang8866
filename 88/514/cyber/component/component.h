...
namespace callback_trace_detail {

inline std::string ComponentDetail(const std::string& module,
                                   const std::string& messages) {
  return std::string("module=") + module + " received_msg=" + messages;
}

template <typename M0>
std::string MessageTypes() {
  return common::DemangleTypeName(message::MessageType<M0>().c_str());
}

template <typename M0, typename M1>
std::string MessageTypes() {
  return common::DemangleTypeName(message::MessageType<M0>().c_str()) + "," +
         common::DemangleTypeName(message::MessageType<M1>().c_str());
}
...
std::string MessageTypes() {
  return common::DemangleTypeName(message::MessageType<M0>().c_str()) + "," +
         common::DemangleTypeName(message::MessageType<M1>().c_str()) + "," +
         common::DemangleTypeName(message::MessageType<M2>().c_str());
}
...
std::string MessageTypes() {
  return common::DemangleTypeName(message::MessageType<M0>().c_str()) + "," +
         common::DemangleTypeName(message::MessageType<M1>().c_str()) + "," +
         common::DemangleTypeName(message::MessageType<M2>().c_str()) + "," +
         common::DemangleTypeName(message::MessageType<M3>().c_str());
}
...
bool Component<M0, NullType, NullType, NullType>::Process(
  ...
  common::CallbackTrace trace(
      "component", node_->Name(),
      callback_trace_detail::ComponentDetail(
          common::DemangleTypeName(typeid(*this).name()),
          callback_trace_detail::MessageTypes<M0>()));
  return Proc(msg);
}
...
bool Component<M0, M1, NullType, NullType>::Process(
  ...
  common::CallbackTrace trace(
      ...
      callback_trace_detail::ComponentDetail(
          common::DemangleTypeName(typeid(*this).name()),
          callback_trace_detail::MessageTypes<M0, M1>()));
  return Proc(msg0, msg1);
}
...
bool Component<M0, M1, M2, NullType>::Process(const std::shared_ptr<M0>& msg0,
  ...
  common::CallbackTrace trace(
      ...
      callback_trace_detail::ComponentDetail(
          common::DemangleTypeName(typeid(*this).name()),
          callback_trace_detail::MessageTypes<M0, M1, M2>()));
  return Proc(msg0, msg1, msg2);
}
...
bool Component<M0, M1, M2, M3>::Process(const std::shared_ptr<M0>& msg0,
  ...
  common::CallbackTrace trace(
      ...
      callback_trace_detail::ComponentDetail(
          common::DemangleTypeName(typeid(*this).name()),
          callback_trace_detail::MessageTypes<M0, M1, M2, M3>()));
  return Proc(msg0, msg1, msg2, msg3);
}
...
#define CYBER_REGISTER_COMPONENT(name) \
  CLASS_LOADER_REGISTER_CLASS(name, century::cyber::ComponentBase)
