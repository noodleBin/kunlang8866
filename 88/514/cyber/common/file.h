...
bool AddProtoToASCIIFile(const google::protobuf::Message &message,
                         int file_descriptor);
bool AddProtoToASCIIFile(const google::protobuf::Message &message,
...
/**
 * @brief put string as file content, std::ios::trunc
 * @param file_name The name of the file to read content.
 * @param content The file content.
 * @return If the action is successful.
 */
bool PutContent(const std::string &file_name, const std::string &content);
