...
2. If we have Non-NVME disk, it will only record smaller topics (blacklist LARGE_TOPICS), unless '--all' is
   specified.
3. If no external disks are available, we will take '/century' as a
...
LARGE_TOPICS = [
    ...
    '/century/sensor/lidar16/PointCloud2',
    '/century/sensor/lidar16/Scan',
    ...
    '/century/sensor/microphone',
    '/century/sensor/radar/front',
    '/century/sensor/radar/rear',
