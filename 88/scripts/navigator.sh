...
${CENTURY_BIN_PREFIX}/modules/map/relative_map/tools/navigator --navigator_config_filename=/century/modules/map/relative_map/conf/navigator_config.pb.txt "${CTRL_ARGS[@]}" "${PATH_NAME[@]}"
