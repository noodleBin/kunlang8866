...
CLOUD_TOPIC="/century/sensor/$LIDAR_TYPE/compensator/PointCloud2"

function data_exporter() {
  local BAG_FILE=$1
  local OUT_FOLDER=$2
  /century/bazel-bin/modules/localization/msf/local_tool/data_extraction/cyber_record_parser \
    --bag_file $BAG_FILE \
...
function poses_interpolation() {
  ...
  /century/bazel-bin/modules/localization/msf/local_tool/map_creation/poses_interpolator \
...
function create_lossless_map() {
  /century/bazel-bin/modules/localization/msf/local_tool/map_creation/lossless_map_creator \
...
function create_lossy_map() {
  /century/bazel-bin/modules/localization/msf/local_tool/map_creation/lossless_map_to_lossy_map \
