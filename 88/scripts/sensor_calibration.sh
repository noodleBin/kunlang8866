...
function calibrate_camera_camera() {
  LOG="${CENTURY_ROOT_DIR}/data/log/camera_camera_calibrator.out"
  ...
  if [ "${NUM_PROCESSES}" -eq 0 ]; then
    ...
    eval "${CENTURY_ROOT_DIR}/modules/calibration/${MODULE}/${MODULE} \
      --flagfile=${CENTURY_ROOT_DIR}/modules/calibration/${MODULE}/conf/${MODULE}.conf \
      2>&1 | tee ${LOG}"
...
function calibrate_lidar_camera() {
  LOG="${CENTURY_ROOT_DIR}/data/log/camera_lidar_calibrator.out"
...
function calibrate_radar_camera() {
  LOG="${CENTURY_ROOT_DIR}/data/log/camera_radar_calibrator.out"
...
function visualize_radar_lidar() {
  LOG="${CENTURY_ROOT_DIR}/data/log/radar_lidar_visualizer.out"
...
function calibrate_imu_vehicle() {
  LOG="${CENTURY_ROOT_DIR}/data/log/imu_car_calibrator.out"
