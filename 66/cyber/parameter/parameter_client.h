...
class ParameterClient {
 public:
  using Param = century::cyber::proto::Param;
  using NodeName = century::cyber::proto::NodeName;
  using ParamName = century::cyber::proto::ParamName;
  using BoolResult = century::cyber::proto::BoolResult;
  using Params = century::cyber::proto::Params;
