...
Century Cyber RT framework is built upon the concept of components. As the
...
> **Note**: The examples need to run after successfully built within Century
> Docker container.
...
module_config {
module_library : "/century/bazel-bin/cyber/examples/common_component_example/libcommon_component_example.so"
components {
    class_name : "CommonComponentSample"
    config {
        name : "common"
        readers {
            channel: "/century/prediction"
        }
        readers {
            channel: "/century/test"
        }
    }
  }
}
...
<cyber>
    <component>
        <name>common</name>
        <dag_conf>/century/cyber/examples/common_component_example/common.dag</dag_conf>
...
source cyber/setup.bash
export GLOG_alsologtostderr=1
/century/bazel-bin/cyber/examples/common_component_example/channel_test_writer
```
...
source cyber/setup.bash
export GLOG_alsologtostderr=1
/century/bazel-bin/cyber/examples/common_component_example/channel_prediction_writer
```
