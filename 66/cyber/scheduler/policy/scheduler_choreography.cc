...
using century::cyber::base::AtomicRWLock;
using century::cyber::base::ReadLockGuard;
using century::cyber::base::WriteLockGuard;
...
using century::cyber::croutine::RoutineState;
...
SchedulerChoreography::SchedulerChoreography()
  ...
  if (PathExists(cfg_file) && GetProtoFromFile(cfg_file, &cfg)) {
    ...
    const century::cyber::proto::ChoreographyConf& choreography_conf =
