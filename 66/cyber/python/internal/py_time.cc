...
using century::cyber::PyDuration;
using century::cyber::PyRate;
using century::cyber::PyTime;
...
PyObject* cyber_new_PyTime(PyObject* self, PyObject* args) {
  ...
  return PyCapsule_New(pytime, "century_cybertron_pytime", nullptr);
}
...
PyObject* cyber_delete_PyTime(PyObject* self, PyObject* args) {
  ...
  auto* pytime = reinterpret_cast<PyTime*>(
      PyCapsule_GetPointer(pyobj_time, "century_cybertron_pytime"));
  if (nullptr == pytime) {
...
PyObject* cyber_new_PyDuration(PyObject* self, PyObject* args) {
  ...
  return PyCapsule_New(pyduration, "century_cybertron_pyduration", nullptr);
}
...
PyObject* cyber_delete_PyDuration(PyObject* self, PyObject* args) {
  ...
  auto* pyduration = reinterpret_cast<PyDuration*>(
      PyCapsule_GetPointer(pyobj_duration, "century_cybertron_pyduration"));
...
PyObject* cyber_new_PyRate(PyObject* self, PyObject* args) {
  ...
  return PyCapsule_New(pyrate, "century_cybertron_pyrate", nullptr);
}
...
PyObject* cyber_delete_PyRate(PyObject* self, PyObject* args) {
  ...
  auto* pyrate = reinterpret_cast<PyRate*>(
      PyCapsule_GetPointer(pyobj_rate, "century_cybertron_pyrate"));
  if (nullptr == pyrate) {
