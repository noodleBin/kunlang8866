...
In Century 5.5, the monitor module now performs the following checks among others:
...
century::monitor::ProcessConf proto, which works similar to
```bash
...
century::monitor::TopicConf proto.
