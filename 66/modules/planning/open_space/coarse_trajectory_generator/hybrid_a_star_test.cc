 ...
 public:
  virtual void SetUp() {
    FLAGS_planner_open_space_config_filename =
        "/century/modules/planning/testdata/conf/"
...
TEST_F(HybridATest, test1) {
  ...
  ASSERT_TRUE(hybrid_test->Plan(world_obstacles_vertices_vec, sx, sy, sphi, ex,
                                ey, ephi, rotate_angle, translate_origin,
                                XYbounds_, obs, obstacles_list, &result));
}
}  // namespace planning
}  // namespace century
