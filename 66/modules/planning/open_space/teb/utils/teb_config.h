...
class TebConfig {
 public:
  ...
  struct Robot {
    ...
    double jerk_lim_x;      //!< Maximum x velocity jerk x of the robot
  ...
  struct Obstacles {
    ...
    double obstacle_association_cutoff_s;
  ...
  struct Optimization {
    ...
    double weight_jerk_lim_x;
    double weight_jerk_lim_theta;
  ...
  TebConfig() {
    ...
    goal_tolerance.xy_goal_tolerance = 0.4;
    ...
    obstacles.obstacle_association_cutoff_s = 5;
    ...
    optim.weight_acc_lim_x = 0;
    optim.weight_acc_lim_y = 0;
    optim.weight_acc_lim_theta = 0;
    optim.weight_kinematics_nh = 10;
    optim.weight_kinematics_forward_drive = 50;
    optim.weight_kinematics_turning_radius = 5.0;
    optim.weight_optimaltime = 0;
    optim.weight_shortest_path = 0;
    optim.weight_obstacle = 200;
    optim.weight_inflation = 200.0;
    optim.weight_dynamic_obstacle = 0;
