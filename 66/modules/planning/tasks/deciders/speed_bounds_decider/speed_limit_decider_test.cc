...
TEST_F(SpeedLimitDeciderTest, Init) {
  SpeedLimitDecider speed_limit_decider(config_, reference_line_info_,
                                        context_);

  EXPECT_TRUE(task_config_.has_speed_bounds_decider_config());
}
