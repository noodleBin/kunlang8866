...
class PathReuseDecider : public Decider {
 ...
 private:
  ...
  common::Status OriginProcess(Frame* frame,
  ...
  bool TrimLastPath(Frame* frame, ReferenceLineInfo* const reference_line_info);

  bool ShortLaneChangePath(ReferenceLineInfo* const reference_line_info,
