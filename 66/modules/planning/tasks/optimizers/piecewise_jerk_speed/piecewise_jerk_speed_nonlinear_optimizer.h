...
class PiecewiseJerkSpeedNonlinearOptimizer : public SpeedOptimizer {
 public:
  explicit PiecewiseJerkSpeedNonlinearOptimizer(
 ...
 private:
  ...
  common::Status UseSoftBound(const SpeedData& speed_data);
  ...
  common::Status CheckData(const PathData& path_data,
                           SpeedData* const speed_data);
  common::Status GetWarmStart(std::vector<double>* distance,
                      std::vector<double>* velocity,
                      std::vector<double>* acceleration,
