...
class ConstantAccToTargetVTrajectory1d : public Curve1d {
 public:
  ConstantAccToTargetVTrajectory1d(const double init_s, const double init_v,
                                   const double target_v, const double a);

  virtual ~ConstantAccToTargetVTrajectory1d() = default;
