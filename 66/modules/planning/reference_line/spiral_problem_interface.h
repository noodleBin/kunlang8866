...
class SpiralProblemInterface : public Ipopt::TNLP {
 ...
 private:
  ...
  void get_variables_info(double* x_l, double* x_u);
  void set_values(int* iRow, int* jCol, int nele_jac);
  void set_x_values(const double x_diff, const double y_diff,
                    ...
                    double* values);
  void set_constraint_offset_values(int* iRow, int* jCol, int nele_jac,
                                    int nz_index);
