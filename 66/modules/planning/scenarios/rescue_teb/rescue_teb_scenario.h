...
class RescueTebScenario : public Scenario {
 public:
  RescueTebScenario(const ScenarioConfig& config,
  ...
  RescueTebContext* GetContext() { return &context_; }
