...
bool CosThetaIpoptInterface::eval_grad_f(int n, const double* x, bool new_x,
  ...
  for (size_t i = 0; i < num_of_points_ - 2; ++i) {
    ...
    if (common::util::IsFloatEqual(q1, 0.0)) {
      AERROR << "the q1 is zero!";
      q1 = FLAGS_numerical_epsilon;
    }
    if (common::util::IsFloatEqual(q2, 0.0)) {
      AERROR << "the q2 is zero!";
      q2 = FLAGS_numerical_epsilon;
    }
    double q3 =
...
void CosThetaIpoptInterface::eval_h_v1(const int n, const double* x, bool new_x,
                                       double obj_factor, const int m,
...
void CosThetaIpoptInterface::eval_h_v2(const int n, const double* x, bool new_x,
                                       double obj_factor, const int m,
                                       const double* lambda, bool new_lambda,
                                       int nele_hess, int* iRow, int* jCol,
                                       double* values) {
...
void CosThetaIpoptInterface::eval_h_v3(const int n, const double* x, bool new_x,
                                       double obj_factor, const int m,
                                       const double* lambda, bool new_lambda,
                                       int nele_hess, int* iRow, int* jCol,
                                       double* values) {
...
bool CosThetaIpoptInterface::eval_h(const int n, const double* x, bool new_x,
                                    double obj_factor, const int m,
                                    const double* lambda, bool new_lambda,
                                    int nele_hess, int* iRow, int* jCol,
                                    double* values) {
  if (use_automatic_differentiation_) {
    eval_h_v1(n, x, new_x, obj_factor, m, lambda, new_lambda, nele_hess, iRow,
              jCol, values);
    return true;
  }
  if (nullptr == values) {
    eval_h_v2(n, x, new_x, obj_factor, m, lambda, new_lambda, nele_hess, iRow,
              jCol, values);
  } else {
    eval_h_v3(n, x, new_x, obj_factor, m, lambda, new_lambda, nele_hess, iRow,
              jCol, values);
  }
  return true;
}
