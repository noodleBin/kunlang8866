...
class NaviSpeedDecider : public NaviTask {
 ...
 private:
   ...
   */
  century::common::Status MakeSpeedDecision(
   ...
   */
  century::common::Status AddPerceptionRangeConstraints();
   ...
   * @return Status::OK() if success; error otherwise.
   */
  century::common::Status AddObstaclesConstraints(
   ...
   * @return Status::OK() if success; error otherwise.
   */
  century::common::Status AddTrafficDecisionConstraints();
   ...
   * @return Status::OK() if success; error otherwise.
   */
  century::common::Status AddCentricAccelerationConstraints(
      const std::vector<common::PathPoint>& path_points);
   ...
   * @return Status::OK() if success; error otherwise.
   */
  century::common::Status AddConfiguredConstraints();

  void RecordDebugInfo(const SpeedData& speed_data);

  void GenerateSpeedPoint(const double start_s,
      std::vector<NaviSpeedTsPoint>* const ts_points,
      SpeedData* const speed_data);

  void CalculateAccelerationConstraints(
      const std::vector<common::PathPoint>& path_points,
