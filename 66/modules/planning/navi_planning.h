...
class NaviPlanning : public PlanningBase {
 public:
   ...
   */
  century::common::Status Init(const PlanningConfig& config) override;
 ...
 private:
  ...
  bool CheckSanity(const LocalView& local_view,
                   ADCTrajectory* const trajectory_pb,
                   const double& start_timestamp);
  bool FrameCheck(ADCTrajectory* const trajectory_pb,
