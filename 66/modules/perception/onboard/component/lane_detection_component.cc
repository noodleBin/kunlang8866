...
void LaneDetectionComponent::OnReceiveImage(
  ...
  // protobuf msg
  std::shared_ptr<century::perception::PerceptionLanes> out_message(
      new (std::nothrow) century::perception::PerceptionLanes);
...
int LaneDetectionComponent::InitConfig() {
  ...
  century::perception::onboard::LaneDetection lane_detection_param;
...
int LaneDetectionComponent::InternalProc(
    ...
    century::perception::PerceptionLanes *out_message) {
  ...
  *error_code = century::common::ErrorCode::OK;
  ...
  std::shared_ptr<century::perception::PerceptionLanes> lanes_msg(
      new (std::nothrow) century::perception::PerceptionLanes);
...
int LaneDetectionComponent::MakeProtobufMsg(
    ...
    century::perception::PerceptionLanes *lanes_msg) {
  ...
  // Fill header info.
  century::common::Header *header = lanes_msg->mutable_header();
