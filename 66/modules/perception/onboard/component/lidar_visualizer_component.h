...
class LidarVisualizerComponent
 ...
 private:
  ...
  void OnReceiveImage(const std::shared_ptr<drivers::CompressedImage>& compressed_image);

  void OnFrontLeftReceiveImage(const std::shared_ptr<drivers::CompressedImage>& compressed_image);
  void OnFrontMidReceiveImage(const std::shared_ptr<drivers::CompressedImage>& compressed_image);
  void OnFrontRightReceiveImage(const std::shared_ptr<drivers::CompressedImage>& compressed_image);
  void OnRearLeftReceiveImage(const std::shared_ptr<drivers::CompressedImage>& compressed_image);
  void OnRearMidReceiveImage(const std::shared_ptr<drivers::CompressedImage>& compressed_image);
  void OnRearRightReceiveImage(const std::shared_ptr<drivers::CompressedImage>& compressed_image);
  bool KeyHandler(const int key);

  void ShowImages(const std::shared_ptr<drivers::CompressedImage>& compressed_image,const std::string& label) noexcept;
