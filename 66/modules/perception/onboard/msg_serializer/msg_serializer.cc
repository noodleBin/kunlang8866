...
bool MsgSerializer::ConvertObjectToPb(const base::ObjectPtr &object_ptr,
  ...
  century::common::Point3D *obj_acceleration = pb_msg->mutable_acceleration();
  ...
  // auto subtypeMapping = [](base::ObjectSubType& subtype) {
  //   switch (subtype) {
  //         case base::ObjectSubType::CAR:
  //         case base::ObjectSubType::IGV_FULL:
  //         case base::ObjectSubType::IGV_EMPTY:
  //         case base::ObjectSubType::TRUCK:
  //         case base::ObjectSubType::LORRY:
  //         case base::ObjectSubType::CONSTRUCTION_VEHICLE:
  //         case base::ObjectSubType::TRAILER_EMPTY:
  //         case base::ObjectSubType::TRAILER_FULL:
  //         case base::ObjectSubType::CRANE:
  //         case base::ObjectSubType::CONTAINER_FORKLIFT:
  //         case base::ObjectSubType::FORKLIFT:
  //         case base::ObjectSubType::OTHER_VEHICLE: return PerceptionObstacle::ST_CAR;
  //         case base::ObjectSubType::CONE: return PerceptionObstacle::ST_TRAFFICCONE;
  //         case base::ObjectSubType::PEDESTRIAN: return PerceptionObstacle::ST_PEDESTRIAN;
  //         default: return PerceptionObstacle::ST_UNKNOWN;
  //   }
  // };
  ...
  // pb_msg->set_sub_type(
  //     subtypeMapping(object_ptr->sub_type));
  ...
  if (FLAGS_obs_save_fusion_supplement &&
    ...
    for (const auto &measurement : object_ptr->fusion_supplement.measurements) {
      ...
      century::common::Point3D *pb_position =
          pb_measurement->mutable_position();
      ...
      century::common::Point3D *pb_velocity =
          pb_measurement->mutable_velocity();
  ...
  //    century::perception::DebugMessage *dmsg = pb_msg->mutable_msg();
  //    century::perception::Trajectory *target_traj = dmsg->add_trajectory();
  //    const century::prediction::Trajectory &src_traj =
