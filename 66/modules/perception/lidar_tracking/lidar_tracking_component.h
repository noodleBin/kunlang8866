...
class LidarTrackingComponent : public century::cyber::Component<LidarFrameMessage> {
 public:
  /**
   * @brief Constructor
   */
  ...
  std::shared_ptr<SensorFrameMessage> GetSensorFrameMessage() const ;
 ...
 private:
  ...
  const bool use_fase_tracker_ = false;
  std::shared_ptr<SensorFrameMessage> out_message_;
