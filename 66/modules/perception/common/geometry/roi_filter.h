...
bool IsPtInRoi(
    const std::shared_ptr<const century::perception::base::HdmapStruct> roi,
    const century::perception::base::PointD pt);

// @brief: whether an object's center is in ROI.
bool IsObjectInRoi(
    const std::shared_ptr<const century::perception::base::HdmapStruct> roi,
    const std::shared_ptr<const century::perception::base::Object> obj);
...
bool ObjectInRoiCheck(
    const std::shared_ptr<const century::perception::base::HdmapStruct> roi,
    const std::vector<std::shared_ptr<century::perception::base::Object>>& objs,
    std::vector<std::shared_ptr<century::perception::base::Object>>* valid_objs);
