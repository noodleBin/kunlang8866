...
using century::perception::base::BaseCameraDistortionModel;
using century::perception::base::BaseCameraModel;
...
class SensorManager {
 public:
  ...
  bool GetSensorInfo(const std::string& name,
                     century::perception::base::SensorInfo* sensor_info) const;
  ...
  bool IsHdLidar(const century::perception::base::SensorType& type) const;
  bool IsLdLidar(const std::string& name) const;
  bool IsLdLidar(const century::perception::base::SensorType& type) const;

  bool IsLidar(const std::string& name) const;
  bool IsLidar(const century::perception::base::SensorType& type) const;
  bool IsRadar(const std::string& name) const;
  bool IsRadar(const century::perception::base::SensorType& type) const;
  bool IsCamera(const std::string& name) const;
  bool IsCamera(const century::perception::base::SensorType& type) const;
  bool IsUltrasonic(const std::string& name) const;
  bool IsUltrasonic(const century::perception::base::SensorType& type) const;
 ...
 private:
  ...
  std::unordered_map<std::string, century::perception::base::SensorInfo>
      sensor_info_map_;
