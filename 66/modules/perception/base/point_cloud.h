...
typedef AttributePointCloud<PointXYZIRTF> PointXYZIRTFCloud;
...
typedef std::shared_ptr<PointXYZIRTFCloud> PointXYZIRTFCloudPtr;
typedef std::shared_ptr<const PointXYZIRTFCloud> PointXYZIRTFCloudConstPtr;
