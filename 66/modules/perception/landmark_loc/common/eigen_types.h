...
static bool InMap(const double x, const double y) {
  const std::array<double, 4UL> map_scope = {-3185.0, -2653, 2082,2197};
  return (x >= map_scope[0]) && (x <= map_scope[1]) && (y >= map_scope[2]) && (y <= map_scope[3]);
}
