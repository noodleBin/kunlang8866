...
POINT_CLOUD_REGISTER_POINT_STRUCT(century::perception::lidar::PointXYZIR,
                                  (float, x, x)(float, y, y)(float, z, z)(
                                      std::uint16_t, timestamp_2us,
                                      timestamp_2us)(std::uint8_t, intensity,
                                                     intensity)(std::uint8_t, ring,
                                                                ring))

POINT_CLOUD_REGISTER_POINT_STRUCT(century::perception::lidar::PCLPointXYZIT,
                                  (float, x, x)(float, y, y)(float, z, z)(
                                      std::uint8_t, intensity,
                                      intensity)(double, timestamp, timestamp))

POINT_CLOUD_REGISTER_POINT_STRUCT(century::perception::lidar::PCLPointXYZL,
                                  (float, x, x)(float, y, y)(float, z, z)(
