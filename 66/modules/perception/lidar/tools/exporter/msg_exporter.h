...
class MsgExporter {
 public:
  typedef century::drivers::Image ImgMsg;
  typedef century::drivers::PointCloud PcMsg;

 public:
  MsgExporter(std::shared_ptr<century::cyber::Node> node,
 ...
 private:
  std::shared_ptr<century::cyber::Node> _cyber_node;
