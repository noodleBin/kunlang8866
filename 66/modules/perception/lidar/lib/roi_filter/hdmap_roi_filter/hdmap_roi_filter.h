...
class HdmapROIFilter : public BaseROIFilter {
 ...
 private:
  void TransformFrame(
      ...
      const century::common::EigenVector<base::PolygonDType*>& polygons_world,
      century::common::EigenVector<base::PolygonDType>* polygons_local,
      base::PointFCloudPtr* cloud_local);

  bool FilterWithPolygonMask(
      const base::PointFCloudPtr& cloud,
      const century::common::EigenVector<base::PolygonDType>& map_polygons,
  ...
  century::common::EigenVector<base::PolygonDType*> polygons_world_;
  century::common::EigenVector<base::PolygonDType> polygons_local_;
  Bitmap2D bitmap_;
