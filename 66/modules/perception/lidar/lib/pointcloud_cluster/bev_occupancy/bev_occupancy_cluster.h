...
class BevOccupancyCluster : public BasePointCloudCluster {
 public:
 BevOccupancyCluster() = default;
  ~BevOccupancyCluster() override = default;
  ...
  std::string Name() const override { return "BevOccupancyCluster"; }

 private:
  bool use_map_manager_;
  MapManager map_manager_;
  size_t min_cluster_point_size_ = 3;
  double bev_resolution_{0.7};
