...
using century::perception::base::PointF;
using ObjectPtr = std::shared_ptr<century::perception::base::Object>;
using PointFCloud = century::perception::base::PointCloud<PointF>;
using PolygonDType = century::perception::base::PointCloud<PointD>;
