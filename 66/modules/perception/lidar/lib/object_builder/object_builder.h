...
class ObjectBuilder {
 ...
 private:
  ...
  void ComputePolygon2D(
      std::shared_ptr<century::perception::base::Object> object);
  ...
  bool LinePerturbation(
      century::perception::base::PointCloud<century::perception::base::PointF>*
          cloud);

  // @brief: calculate 3D min max point
  // @param [in]: point cloud.
  // @param [in/out]: min and max points.
  void GetMinMax3D(const century::perception::base::PointCloud<
                       century::perception::base::PointF>& cloud,
