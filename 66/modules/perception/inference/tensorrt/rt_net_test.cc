...
//   century::perception::inference::BatchStream stream;
...
//   century::perception::inference::RTNet *rt_net =
//       new century::perception::inference::RTNet(proto_file, weight_file,
//       outputs,
...
//   century::perception::inference::Inference *rt_net = nullptr;
//   std::vector<std::string> inputs{"data", "bad"};

//   rt_net = century::perception::inference::CreateInferenceByName(
...
//                                    "ori_pred", "dim_pred", "lof_pred",
//                                    "lor_pred"};
//   century::perception::inference::load_data<std::string>(output_blob_path,
//                                                         &outputs);
//   century::perception::inference::Inference *rt_net = nullptr;
...
//   century::perception::inference::load_binary_data(result_file); int idx = 0;
...
//   century::perception::inference::load_data<std::string>(output_blob_path,
//                                                         &outputs);
//   std::shared_ptr<century::perception::inference::Inference> rt_net;

//   rt_net.reset(century::perception::inference::CreateInferenceByName(
...
//   auto gt = century::perception::inference::load_binary_data(result_file);
//   int idx = 0;
//   for (int img_idx = 0;
