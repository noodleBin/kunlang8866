...
TEST(SlicePluginsTest, test) {
  // century::perception::inference::SliceParameter slice_param;
  ...
  // century::perception::inference::SLICEPlugin slice_plugin(slice_param, in_dims);
  ...
  // century::perception::inference::SLICEPlugin slice_plugin2(slice_param,
  //                                                          in_dims);
