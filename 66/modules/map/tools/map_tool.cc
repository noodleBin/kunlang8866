...
static void OutputMap(const Map& map_pb) {
  ...
  ACHECK(century::cyber::common::SetProtoToASCIIFile(map_pb, txt_file));
  ACHECK(century::cyber::common::SetProtoToBinaryFile(map_pb, bin_file));
}
...
int main(int32_t argc, char** argv) {
  ...
  ACHECK(century::cyber::common::GetProtoFromFile(map_file, &map_pb))
