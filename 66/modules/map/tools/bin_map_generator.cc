...
DEFINE_string(output_dir, "/century/modules/map/data/txt_to_bin",
...
int main(int argc, char *argv[]) {
  ...
  FLAGS_map_dir = "/century/modules/map/data/txt_to_bin";
  ...
  if (!century::cyber::common::SetProtoToBinaryFile(pb_map, output_bin_file)) {
