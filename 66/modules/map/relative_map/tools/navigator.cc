...
using century::relative_map::NavigationPath;
using century::relative_map::NavigatorConfig;
using nlohmann::json;
...
void CheckConfig(const century::relative_map::NavigatorConfig& navigator_config);
...
int main(int argc, char** argv) {
  ...
  if (!century::cyber::common::GetProtoFromFile(FLAGS_navigator_config_filename,
                                               &navigator_config)) {
  ...
  std::shared_ptr<century::cyber::Node> node(
      century::cyber::CreateNode("navigation_info"));
  auto writer = node->CreateWriter<century::relative_map::NavigationInfo>(
  ...
  while (century::cyber::OK()) {
    ...
    century::common::util::FillHeader(node->Name(), &navigation_info);
...
void CheckConfig(
    const century::relative_map::NavigatorConfig& navigator_config) {
