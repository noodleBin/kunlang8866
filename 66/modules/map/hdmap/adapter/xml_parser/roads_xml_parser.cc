...
Status RoadsXmlParser::to_pb_road_type(const std::string& type,
  ...
  if (upper_type == "UNKNOWN") {
    *pb_road_type = century::hdmap::Road::UNKNOWN;
  } else if (upper_type == "HIGHWAY") {
    *pb_road_type = century::hdmap::Road::HIGHWAY;
  } else if (upper_type == "CITYROAD") {
    *pb_road_type = century::hdmap::Road::CITY_ROAD;
  } else if (upper_type == "PARK") {
    *pb_road_type = century::hdmap::Road::PARK;
  } else {
