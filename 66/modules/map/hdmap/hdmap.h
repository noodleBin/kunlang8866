...
class HDMap {
 public:
  ...
  /**
   * @brief get all electric_fences in certain range
   * @param point the central point of the range
   * @param distance the search radius
   * @param electric_fences store all electric_fences in target range
   * @return 0:success, otherwise failed
   */
  ...
  int GetObstacleAreas(const century::common::PointENU& point,
                       const double distance,
