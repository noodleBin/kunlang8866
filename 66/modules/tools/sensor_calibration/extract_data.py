...
SMALL_TOPICS = [
    ...
    '/century/localization/msf_status',
    '/century/monitor',
...
flags.DEFINE_string('root_dir', '/century/modules/tools/sensor_calibration',
                    'program root dir')
...
class Extractor(object):
    def __init__(self):
        ...
        self.writer = self.node.create_writer("/century/dreamview/progress",
    ...
    def build_parser(channel, output_path):
        ...
        elif channel.startswith("/century/sensor/radar"):
    ...
    def reorganize_extracted_data(self,
        ...
        if task_name == 'lidar_to_gnss':
            subfolders = [
                ...
                if '_century_sensor_' in x or '_localization_pose' in x
            ]
            odometry_subfolders = [
...
if __name__ == '__main__':
    # root_path = '/century/data/extracted_data/MKZ5-2019-05-15/lidar_to_gnss-2019-11-25-11-02/tmp'
    # task_name = 'lidar_to_gnss'
    # root_path = '/century/data/extracted_data/udevl002-2019-06-14/camera_to_lidar-2019-11-26-19-49/tmp'
