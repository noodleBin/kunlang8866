...
class PointCloudParser(SensorMessageParser):
    """
    class to parse century/$(lidar)/PointCloud2 channels.
    ...
    def parse_sensor_message(self, msg):
        ...
        # TODO(gchen-Century): add saint check
        return True


class ImageParser(SensorMessageParser):
    """
    class to parse century/$(camera)/image channels.
    saving separately each parsed msg
    """
...
class ContiRadarParser(SensorMessageParser):
    """
    class to parse century/sensor/radar/$(position) channels.
    saving separately each parsed msg
    """
