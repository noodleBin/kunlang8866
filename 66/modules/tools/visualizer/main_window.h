...
class MainWindow : public QMainWindow {
 ...
 public:
  ...
  void TopologyChanged(const century::cyber::proto::ChangeMsg& change_msg);
  void AddNewWriter(const century::cyber::proto::RoleAttributes& role);
 ...
 private:
  ...
  CyberChannReader<century::drivers::PointCloud>* pointcloud_channel_Reader_;
