...
function set_global_var() {
  ...
  MAP_DATACHECKER_CLIENT=${CENTURY_ROOT_PATH}/bazel-bin/modules/map/tools/map_datachecker/client/map_datachecker_client
  CONF=${CENTURY_ROOT_PATH}/modules/map/tools/map_datachecker/conf/map-datachecker.conf
  LOG_DIR=${CENTURY_ROOT_PATH}/modules/tools/map_datachecker/log
}
