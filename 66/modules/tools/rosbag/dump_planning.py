...
def dump_bag(in_bag, out_dir):
    ...
    global g_args
    topic_name_map = {
        "/century/localization/pose": ["localization", None],
        "/century/canbus/chassis": ["chassis", None],
        "/century/routing_response": ["routing", None],
        "/century/routing_resquest": ["routing_request", None],
        "/century/perception/obstacles": ["perception", None],
        "/century/prediction": ["prediction", None],
        "/century/planning": ["planning", None],
        "/century/control": ["control", None]
    }
    first_time = None
    record_num = 0
