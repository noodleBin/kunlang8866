...
if __name__ == "__main__":
    ...
    if args.bag:
        ...
        for msg in reader.read_messages():
            ...
            elif msg.topic == "/century/canbus/chassis":
        ...
        planningsub = node.create_reader('/century/planning',
                                         planning_pb2.ADCTrajectory,
                                         controlinfo.callback_planning)
        localizationsub = node.create_reader(
            '/century/localization/pose', localization_pb2.LocalizationEstimate,
            controlinfo.callback_localization)
        controlsub = node.create_reader('/century/control',
                                        control_cmd_pb2.ControlCommand,
                                        controlinfo.callback_control)
        canbussub = node.create_reader('/century/canbus/chassis',
                                       chassis_pb2.Chassis,
