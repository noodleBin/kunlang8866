...
In **PerceptionConf** section, the *perception* parameter is to specify the perception  solution. Currently there are three supported in Century Navigation Mode: mobileye based, camera based and lidar based.
