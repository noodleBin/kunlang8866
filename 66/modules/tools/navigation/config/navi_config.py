...
DEFAULT_NAVI_CONFIG_FILE = "/century/modules/tools/navigation/config/default.ini"
HMI_CONF_FILE = "/century/modules/dreamview/conf/hmi.conf"
PLANNING_CONF_FILE = "/century/modules/planning/conf/planning_config_navi.pb.txt"
GLOBAL_FLAG_FILE = "/century/modules/common/data/global_flagfile.txt"
LOCALIZATION_FLAG_FILE = "/century/modules/localization/conf/localization.conf"
PLANNING_FLAG_FILE1 = "/century/modules/planning/conf/planning.conf"
PLANNING_FLAG_FILE2 = "/century/modules/planning/conf/planning_navi.conf"
