...
def verify():
    ...
    token_file_name = os.environ['HOME'] + '/.cache/century_update/auth_token'
    with open(token_file_name, 'r') as token_file:
        auth_token = token_file.read()
    sec_package = os.environ['HOME'] + '/.cache/sec_century_release.tar.gz'
    orig_package = os.environ['HOME'] + '/.cache/century_release.tar.gz'
