...
/**
 * @namespace century::canbus::lincoln
 * @brief century::canbus::lincoln
 */
namespace century {
namespace canbus {
namespace lincoln {
...
class LincolnController final : public VehicleController {
 ...
 private:
  ...
  void SetWheelSpeed(const canbus::ChassisDetail &chassis_detail);
  void SetGps(const canbus::ChassisDetail &chassis_detail);
