...
/**
 * @namespace century::drivers::canbus
 * @brief century::drivers::canbus
 */
namespace century {
namespace drivers {
namespace canbus {
...
class CanClient {
 public:
   ...
   */
  virtual century::common::ErrorCode Start() = 0;
   ...
   *         century::common::ErrorCode.
   */
  virtual century::common::ErrorCode Send(const std::vector<CanFrame> &frames,
   ...
   *         century::common::ErrorCode.
   */
  virtual century::common::ErrorCode SendSingleFrame(
   ...
   *         century::common::ErrorCode.
   */
  virtual century::common::ErrorCode Receive(std::vector<CanFrame> *const frames,
                                            int32_t *const frame_num) = 0;
