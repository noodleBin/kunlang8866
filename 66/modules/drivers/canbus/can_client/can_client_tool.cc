...
int main(int32_t argc, char **argv) {
  ...
  using century::drivers::canbus::CanAgent;
  using century::drivers::canbus::CANCardParameter;
  using century::drivers::canbus::CanClient;
  using century::drivers::canbus::CanClientFactory;
  using century::drivers::canbus::TestCanParam;
  ...
  if (!century::cyber::common::GetProtoFromFile(FLAGS_can_client_conf_file_a,
                                               &can_client_conf_a)) {
  ...
  if (!FLAGS_only_one_send) {
    if (!century::cyber::common::GetProtoFromFile(FLAGS_can_client_conf_file_b,
                                                 &can_client_conf_b)) {
      AERROR << "Unable to load canbus conf file: "
