...
class MockProtocolData : public ProtocolData<::century::canbus::ChassisDetail> {
 public:
...
class MockMessageManager
    : public MessageManager<::century::canbus::ChassisDetail> {
 public:
  MockMessageManager() {
...
TEST(MessageManagerTest, GetMutableProtocolDataById) {
  ...
  ::century::canbus::ChassisDetail chassis_detail;
  chassis_detail.set_car_type(::century::canbus::ChassisDetail::QIRUI_EQ_15);
