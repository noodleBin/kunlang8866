...
/**
 * @namespace century::drivers::conti_radar
...
ContiRadarCanbusComponent::ContiRadarCanbusComponent()
    : monitor_logger_buffer_(
          century::common::monitor::MonitorMessageItem::CONTI_RADAR) {}
...
century::common::ErrorCode ContiRadarCanbusComponent::ConfigureRadar() {
