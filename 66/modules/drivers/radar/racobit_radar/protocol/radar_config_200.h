...
using century::drivers::RacobitRadar;
using century::drivers::racobit_radar::OutputType;
using century::drivers::racobit_radar::RadarConf;
using century::drivers::racobit_radar::RcsThreshold;

class RadarConfig200
    : public century::drivers::canbus::ProtocolData<RacobitRadar> {
 public:
