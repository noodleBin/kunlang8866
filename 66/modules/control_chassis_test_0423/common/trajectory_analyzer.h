...
class TrajectoryAnalyzer {
 public:
  ...
  TrajectoryAnalyzer(
      ...
      const bool use_for_lat_control = false);
  ...
  common::TrajectoryPoint QueryNearestPointByAbsoluteTimeInterpolation(
  ...
  common::TrajectoryPoint QueryNearestPointByRelativeTimeInterpolation(
      const double t) const;
  /**
   ...
   * @return a point of trajectory, the point may be a point of trajectory
  ...
  /**
   * @brief query a point of trajectory that nearest s
   * @param s trajectory position
   * @return a point of trajectory, the point may be a point of trajectory
   * or interpolated by two adjacent points of trajectory
   * or expanded by trajectory
   */
  common::TrajectoryPoint QueryNearestPointByS(const double s) const;

  common::TrajectoryPoint QueryNearestPointByPositionInterpolation(
   ...
   * or interpolated by two adjacent points of trajectory
   */
  common::PathPoint QueryNearestPathPoint(const double x, const double y) const;
 ...
 private:
  common::TrajectoryPoint FindMinDistancePoint(const common::TrajectoryPoint &p0,
