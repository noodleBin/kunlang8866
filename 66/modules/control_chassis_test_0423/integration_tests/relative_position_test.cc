...
class RelativePositionTest : public ControlTestBase {
 public:
  virtual void SetUp() {
    FLAGS_test_data_dir =
        "/century/modules/control/testdata/relative_position_test/";
    FLAGS_control_conf_file =
        "/century/modules/control/testdata/conf/control_conf_lite.pb.txt";
...
TEST_F(RelativePositionTest, simple_left) {
  ...
  FLAGS_test_localization_file = "0_century_localization_pose.pb.txt";
  FLAGS_test_pad_file = "0_pad.pb.txt";
  FLAGS_test_planning_file = "0_century_planning.pb.txt";
  FLAGS_test_chassis_file = "0_century_canbus_chassis.pb.txt";
