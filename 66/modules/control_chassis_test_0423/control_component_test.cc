...
void ControlComponentTest::SetupCyber() {
  ...
  century::cyber::Init("control_test");

  Clock::SetMode(century::cyber::proto::MODE_CYBER);
  ...
  std::shared_ptr<century::cyber::Node> node(
      century::cyber::CreateNode("control_test"));
...
TEST_F(ControlComponentTest, simple_test) {
  FLAGS_test_data_dir = "/century/modules/control/testdata/simple_control_test/";
