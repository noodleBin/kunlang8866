...
using OSLightColor = ::century::v2x::SingleTrafficLight_Color;
using OSLightype = ::century::v2x::SingleTrafficLight_Type;
using ObuLightype = ::century::v2x::obu::SingleTrafficLight_Type;
using OSLight = ::century::v2x::IntersectionTrafficLightData;
using ObuLight = ::century::v2x::obu::ObuTrafficLight;
using OSLocation = ::century::localization::LocalizationEstimate;
using OSRsi = ::century::v2x::RsiMsg;
using ObuRsi = ::century::v2x::obu::ObuRsi;
using HDJunction = ::century::hdmap::JunctionInfoConstPtr;
using ObuJunction = ::century::v2x::Junction;
