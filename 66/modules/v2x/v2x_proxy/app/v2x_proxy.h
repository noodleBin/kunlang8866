...
class V2xProxy {
 ...
 public:
  explicit V2xProxy(std::shared_ptr<::century::hdmap::HDMap> hdmap = nullptr);
 ...
 private:
  ...
  std::unique_ptr<::century::cyber::Timer> v2x_car_status_timer_;
  std::unique_ptr<::century::cyber::Timer> obu_status_timer_;
  std::unique_ptr<::century::cyber::Timer> rsu_whitelist_timer_;
  ...
  std::shared_ptr<::century::hdmap::HDMap> hdmap_;
