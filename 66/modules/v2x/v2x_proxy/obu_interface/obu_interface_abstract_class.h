...
class ObuInterFaceBase {
 ...
 public:
  ...
  virtual void GetV2xTrafficLightFromObu(
      std::shared_ptr<::century::v2x::obu::ObuTrafficLight> *msg) {}

  virtual void SendCarStatusToObu(
      const std::shared_ptr<::century::v2x::CarStatus> &msg) {}

  virtual void GetV2xRsiFromObu(
      std::shared_ptr<::century::v2x::obu::ObuRsi> *msg) {}
  virtual void GetV2xObstaclesFromObu(
      std::shared_ptr<::century::v2x::V2XObstacles> *msg) {}
};
