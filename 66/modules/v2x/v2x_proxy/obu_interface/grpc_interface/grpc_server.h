...
class GrpcServerImpl final : public ::century::v2x::ObuToCar::Service {
 public:
  /* construct function
   */
  GrpcServerImpl();
  ...
  */
  grpc::Status SendV2xTrafficLight(
      ...
      const ::century::v2x::obu::ObuTrafficLight *request,
      ::century::v2x::StatusResponse *response) override;
  ...
  */
  grpc::Status SendObuAlarm(grpc::ServerContext *context,
                            const ::century::v2x::ObuAlarm *request,
                            ::century::v2x::StatusResponse *response) override;
  ...
  grpc::Status SendPerceptionObstacles(grpc::ServerContext *context,
                                       const century::v2x::V2XObstacles *request,
                                       StatusResponse *response) override;

  grpc::Status SendV2xRSI(grpc::ServerContext *context,
                          const ::century::v2x::obu::ObuRsi *request,
                          ::century::v2x::StatusResponse *response);

  void GetMsgFromGrpc(
      std::shared_ptr<::century::v2x::obu::ObuTrafficLight> *ptr);

  void GetMsgFromGrpc(std::shared_ptr<::century::v2x::obu::ObuRsi> *ptr);
  void GetMsgFromGrpc(std::shared_ptr<::century::v2x::V2XObstacles> *ptr);
 ...
 private:
  ...
  ::century::v2x::obu::ObuTrafficLight latest_traffic_light_;
  ::century::v2x::obu::ObuRsi latest_rsi_;
  ::century::v2x::V2XObstacles latest_obstacles_;
