...
TEST(Fusion, get_km_result) {
  ...
  LoadData("/century/modules/v2x/fusion/test_data/fusion_object1", &objects1,
           "camera1");
  LoadData("/century/modules/v2x/fusion/test_data/fusion_object2", &objects2,
           "camera2");
  LoadData("/century/modules/v2x/fusion/test_data/fusion_object3", &objects3,
           "camera3");
  LoadData("/century/modules/v2x/fusion/test_data/fusion_object4", &objects4,
           "camera4");
  EXPECT_TRUE(
      fusion.CombineNewResource(objects1, &fused_objects, &fusion_result));
  EXPECT_TRUE(
