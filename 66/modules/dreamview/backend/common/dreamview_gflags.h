...
DECLARE_string(dynamic_file_path);

DECLARE_string(record_cmd_topic);

DECLARE_string(record_status_topic);

DECLARE_string(barrier_command_topic);

DECLARE_int32(barrier_command_publish_interval_ms);

DECLARE_double(barrier_command_auto_stop_seconds);

DECLARE_string(barrier_command_password);
