...
using century::planning::DrivingAction;
using century::planning::PadMessage;
using century::planning::ScenarioConfig;
...
// channels
const std::string modem0_channel = "/century/teleop/modem/modem0";
const std::string modem1_channel = "/century/teleop/modem/modem1";
const std::string modem2_channel = "/century/teleop/modem/modem2";
const std::string remote_daemon_cmd_channel =
    "/century/teleop/daemon/remote/cmd";
const std::string remote_daemon_rpt_channel =
    "/century/teleop/daemon/remote/rpt";
const std::string local_daemon_cmd_channel = "/century/teleop/daemon/local/cmd";
const std::string local_daemon_rpt_channel = "/century/teleop/daemon/local/rpt";
const std::string planning_channel = "/century/planning";
const std::string planning_pad_channel = "/century/planning/pad";
