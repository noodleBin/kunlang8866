...
class Cloud : public IDataHandler {
 ...
 private:
  ...
  std::unordered_map<uint8_t, century::planning::BlockingAreaType>
      accumulated_blocking_areas_;
  bool blocking_areas_need_stop_ = false;
  std::mutex blocking_areas_mutex_;
};
