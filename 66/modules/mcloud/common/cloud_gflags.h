...
DECLARE_int32(cloud_connect_timeout_ms);
DECLARE_int32(cloud_response_timeout_ms);
DECLARE_int32(cloud_report_interval_ms);
DECLARE_int32(cloud_max_reconnect_attempts);
DECLARE_int32(cloud_reconnect_delay_ms);
DECLARE_int32(cloud_buffer_block_max_size);
DECLARE_int32(cloud_rw_block_size);
DECLARE_int32(cloud_circular_buffer_block_count);
...
DECLARE_string(road_event_code_config);
