...
class VisualizationEngine {
 ...
 public:
  ...
  void Visualize(::century::common::EigenVector<LocalizatonInfo> &&loc_infos,
                 const ::century::common::EigenVector3dVec &cloud);
 ...
 private:
  ...
  ::century::common::EigenVector3dVec cloud_;
  cv::Mat cloud_img_;
  ...
  ::century::common::EigenVector<LocalizatonInfo> cur_loc_infos_;
