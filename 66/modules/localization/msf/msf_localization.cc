...
MSFLocalization::MSFLocalization()
    : monitor_logger_(
          century::common::monitor::MonitorMessageItem::LOCALIZATION),
...
void MSFLocalization::OnRawImu(
  ...
  century::common::Header *status_headerpb = status.mutable_header();
...
void MSFLocalization::CompensateImuVehicleExtrinsic(
  ...
  // calculate orientation_vehicle_world
  century::localization::Pose *posepb_loc = local_result->mutable_pose();
  const century::common::Quaternion &orientation = posepb_loc->orientation();
