...
/**
 * @namespace century::prediction
 * @brief century::prediction
 */
namespace century {
...
class PredictorManager {
 public:
   ...
   */
  void Run(const century::perception::PerceptionObstacles& perception_obstacles,
 ...
 private:
  ...
  void PredictObstacles(
      const century::perception::PerceptionObstacles& perception_obstacles,
      const ADCTrajectoryContainer* adc_trajectory_container,
      ObstaclesContainer* obstacles_container);
