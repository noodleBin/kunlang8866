...
class SubmoduleOutput {
 public:
  ...
  void set_frame_start_time(const century::cyber::Time& frame_start_time);
  ...
  const std::vector<century::perception::PerceptionObstacle>&
  ...
  const century::cyber::Time& frame_start_time() const;
 ...
 protected:
  ...
  century::cyber::Time frame_start_time_;
