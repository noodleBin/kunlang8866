...
/**
 * @namespace century::prediction::network
 * @brief century::prediction::network
 */
namespace century {
...
class Layer {
 public:
   ...
   */
  virtual bool Load(const century::prediction::LayerParameter& layer_pb);
...
class Dense : public Layer {
 public:
   ...
   */
  bool Load(const century::prediction::LayerParameter& layer_pb) override;
   ...
   * @return True is loaded successively, otherwise False
   */
  bool Load(const century::prediction::DenseParameter& layer_pb);
...
class Conv1d : public Layer {
 public:
   ...
   * @return True is loaded successively, otherwise False
   */
  bool Load(const century::prediction::Conv1dParameter& conv1d_pb);
...
class MaxPool1d : public Layer {
 public:
   ...
   * @return True is loaded successively, otherwise False
   */
  bool Load(const century::prediction::MaxPool1dParameter& maxpool1d_pb);
...
class AvgPool1d : public Layer {
 public:
   ...
   * @return True is loaded successively, otherwise False
   */
  bool Load(const century::prediction::AvgPool1dParameter& avgpool1d_pb);
...
class Activation : public Layer {
 public:
   ...
   * @return True is loaded successively, otherwise False
   */
  bool Load(const century::prediction::ActivationParameter& activation_pb);
