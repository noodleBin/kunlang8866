...
using century::bridge::BRIDGE_HEADER_FLAG;
using century::bridge::BridgeHeader;
using century::bridge::FRAME_SIZE;
using century::bridge::HEADER_FLAG_SIZE;
using century::bridge::hsize;
using century::bridge::MAXEPOLLSIZE;
using century::canbus::Chassis;
using BPDBChassis = century::bridge::BridgeProtoDiserializedBuf<Chassis>;
