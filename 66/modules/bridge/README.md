...
This module provides a way for other Century modules interactiving with process
outside of Century by socket. It includes sender and receiver components.
...
```
$ cyber_launch start /century/modules/bridge/launch/bridge_receiver.launch
```

The start command of Receiver is as follows:

```
$ cyber_launch start /century/modules/bridge/launch/bridge_sender.launch
```
...
/Century/modules/bridge/conf/udp_bridge_receiver_chassis.pb.txt
...
corresponding file. If you want to add the message century::test::PbTest, as
