...
DECLARE_bool (enable_mass_update_debug);
...
DECLARE_int32(planning_aeb_pending_queue_size);
DECLARE_int32(aeb_enable_size);
...
DECLARE_bool(enable_fill_trajectory_point);

DECLARE_bool(enable_centripetal_acceleration_limited);
DECLARE_bool(enable_secondary_filter);
DECLARE_int32(monitor_pending_queue_size);
DECLARE_bool(enable_check_monitor_input);
DECLARE_uint32(minimum_execution_monitor_level);
DECLARE_int32(emergency_stop_pending_queue_size);
