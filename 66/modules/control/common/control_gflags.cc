...
DEFINE_bool(enable_mass_update_debug, false, "enable mass update debug");
...
DEFINE_int32(planning_aeb_pending_queue_size, 10,
             "Max AEB pending queue size");             
DEFINE_int32(aeb_enable_size, 10,
             "Max AEB enable queue size");              
...
DEFINE_bool(enable_fill_trajectory_point, false,
            "enable fill trajectory point");
DEFINE_bool(enable_centripetal_acceleration_limited, true,
            "Enable centripetal acceleration limited");
DEFINE_bool(enable_secondary_filter, false, "Enable secondary filter");

DEFINE_int32(monitor_pending_queue_size, 10, "Max monitor pending queue size");

DEFINE_bool(enable_check_monitor_input, false,
            "check monitor input if century overtime");
DEFINE_uint32(minimum_execution_monitor_level, 3,
              "minimum execution monitor level ");
DEFINE_int32(emergency_stop_pending_queue_size, 10,
             "Max emergency stop pending queue size");