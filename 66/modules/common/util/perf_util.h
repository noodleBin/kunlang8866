...
#define PERF_FUNCTION()                               \
  century::common::util::TimerWrapper _timer_wrapper_( \
      century::common::util::function_signature(AFUNC))
#define PERF_FUNCTION_WITH_NAME(func_name) \
  century::common::util::TimerWrapper _timer_wrapper_(func_name)
#define PERF_FUNCTION_WITH_INDICATOR(indicator)       \
  century::common::util::TimerWrapper _timer_wrapper_( \
      century::common::util::function_signature(AFUNC, indicator))
#define PERF_BLOCK_START()             \
  century::common::util::Timer _timer_; \
  _timer_.Start()
