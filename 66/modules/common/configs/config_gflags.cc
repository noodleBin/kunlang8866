...
DEFINE_string(map_dir, "/century/modules/map/data/demo",
...
DEFINE_string(vehicle_config_path,
              "/century/modules/common/data/vehicle_param.pb.txt",
              "the file path of vehicle config file");

DEFINE_string(
    vehicle_model_config_filename,
    "/century/modules/common/vehicle_model/conf/vehicle_model_config.pb.txt",
...
DEFINE_double(half_vehicle_width, 0.6785, "half vehicle width");
