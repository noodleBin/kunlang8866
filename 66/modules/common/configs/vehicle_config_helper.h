...
class VehicleConfigHelper {
 public:
   ...
   * @param lat_buffer of a half vehicle lateral safe buffer.
  ...
  /**
   * @brief Get the box (four corners: ABCD) of the vehicle.
   * @param x of a vehicle point x value
   * @param y of a vehicle point y value
   * @param heading of a vehicle heading value
   * @param long_buffer of a half vehicle longitude safe buffer.
   * @param lat_buffer of a half vehicle lateral safe buffer.
   * @return a box2d which contains the ABCD points info.
   */
  static common::math::Box2d GetBoundingBox(const double x, const double y,
                                            const double heading,
                                            const double long_buffer = 0.0,
                                            const double lat_buffer = 0.0);

  static common::math::Box2d GetBoundingBox(const double x, const double y,
                                            const double heading,
                                            const double long_buffer,
