## How to Contribute to Century

### Contributor License Agreements

You are welcome to contribute to the Century project. To contribute, please agree
with the [Century individual contributor license agreement]
(https://gist.githubusercontent.com/startcode/f5ccf8887bfc7727a0ae05bf0d601e30/raw/029a11300e987e34a29a9d247ac30caa7f6741a7/Century_Individual_Contributor_License_Agreement)
first.
...
- There are
  [issues with label "help wanted"](https://github.com/CenturyAuto/century/issues?utf8=%E2%9C%93&q=label%3A%22Type%3A+Help+wanted%22+)
...
- Before sending in your pull request for
  [review](https://github.com/CenturyAuto/century/pulls), make sure your changes
...
- Bash code License example [century_base.sh](scripts/century_base.sh);
...
You can use command `bash century.sh test` to run all unit tests.

#### Coding style

- **C/C++ coding style**: Century adopted the
  [Google C++ Style Guide](https://google.github.io/styleguide/cppguide.html).
  Make sure your code conforms to this style guide. You can use command
  `bash century.sh lint` to check if your code has any style issue.

- **Python coding style**: Century adopted the
...
- **Century best coding practice**: Please also refer to
  [Century Best Coding Practice](docs/technical_tutorial/century_best_coding_practice.md)
  for more coding practice disciplines.

- **BUILD file coding style** : you can use command
  `bash century.sh format path/to/BUILD/files` to format your BUILD files before
  you submit.
...
sufficient comments and documentation. Century uses doxygen to help generate
formatted API Document with command `bash century.sh doc generate`. To document
...
sure your change don't break build/test/lint by running `bash century.sh check`,
which is equivalent to a combination of `bash century.sh build`,
`bash century.sh test` and `bash century.sh lint`.
