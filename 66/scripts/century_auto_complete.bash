# usage: source century_auto_complete.bash
...
MODULES="$(find /century/modules/* -maxdepth 0 -type d -printf "%f ")"
MODULES="cyber ${MODULES}"

function _complete_century_func() {
  COMPREPLY=()
...
complete -F _complete_century_func -o default century.sh
