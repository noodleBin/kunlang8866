...
function start() {
  LOG="${CENTURY_ROOT_DIR}/data/log/camera_and_video.out"
  CMD="cyber_launch start /century/modules/drivers/camera/launch/camera_and_video.launch"
...
function stop() {
  eval "nohup cyber_launch stop /century/modules/drivers/camera/launch/camera_and_video.launch < /dev/null 2>&1 &"
}
