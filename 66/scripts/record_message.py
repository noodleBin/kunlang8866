...
It lists all available disks mounted under /media, and prioritize them in order:
   ...
   - /century. If no external disks are available
...
class Recorder(object):
    ...
    def record_task(self, disk):
        ...
        log_file = '/century/data/log/smart_recorder.out'
        recorder_exe = '/century/bazel-bin/modules/data/tools/smart_recorder/smart_recorder'
        cmd = '''
