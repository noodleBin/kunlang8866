...
routing_topic="/century/routing_response"
planning_topic="/century/planning"
prediction_topic="/century/prediction"
drive_event_topic="/century/drive_event"
pointcloud_topic="/century/sensor/velodyne64/compensator/PointCloud2"
...
perfect_control_topic+=("/century/perception/traffic_light")

planning_deps=()
planning_deps+=${perfect_control_topic[@]}
planning_deps+=('/century/canbus/chassis')
planning_deps+=('/century/localization/pose')
planning_deps+=('/century/navigation')
planning_deps+=('/century/guardian')
planning_deps+=('/century/monitor/system_status')
planning_deps+=('/century/relative_map')
