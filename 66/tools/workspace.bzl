# century external dependencies that can be loaded in WORKSPACE files.
...
load("//third_party/concurrent_queue:workspace.bzl", concurrent_queue = "repo")
...
# Define aell external repositories rquired by
